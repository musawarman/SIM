...
Set rsVisi = Server.CreateObject("ADODB.Recordset")
rsVisi.ActiveConnection = MM_DBConn2_STRING
rsVisi.Source = "SELECT *  FROM dbo.Visi_Misi"
rsVisi.CursorType = 0
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/corporate/index.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
