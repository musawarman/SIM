...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="100"><a href="index.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','img/top_mn_on_06.gif',1)"><img src="img/top_mn-06.gif" alt="Visi &amp; Misi" name="Image8" width="100" height="25" border="0"></a></td>
    <td width="100"><a href="history.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','img/top_mn_on_07.gif',1)"><img src="img/top_mn-07.gif" alt="Sejarah" name="Image9" width="100" height="25" border="0"></a></td>
    <td width="427"><img src="img/bg_mn_top_r1.gif" width="427" height="25"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/corporate/history.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif"><img src="img/history_ttl.gif" height="21"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><div align="justify">&nbsp;&nbsp;&nbsp;PT Sierad Produce Tbk adalah 
              gabungan dari 4 perusahaan pada tahun 2001 yang bergerak di satu 
              bidang bisnis utama di bawah naungan Sierad Group. Empat perusahaan 
              ini adalah PT Anwar Sierad Tbk, PT Sierad Produce Tbk, PT Sierad 
              Feedmill dan PT Sierad Grains.<br>
              <br>
              &nbsp;&nbsp;&nbsp;&nbsp;Sierad Produce, dahulu bernama PT. Betara 
              Darma ekspor impor, berdiri pada tanggal 6 September 1985. Nama 
              Sierad mulai digunakan pada tanggal 27 Desember 1996 saat persiapan 
              untuk public listing yang cukup berhasil di Jakarta Stock Exchange. 
              Bisnis utama perusahaan ini meliputi produksi pakan ternak olahan, 
              breeding, produksi anak ayam, kemitraan, rumah potong ayam dan pembuatan 
              produk olahan bernilai tambah lainnya. </div></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
