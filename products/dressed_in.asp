...
rsProduct.Source = "SELECT prodid, image,name,lead,detail,tabel  FROM dbo.Product  WHERE Prodid = " + Replace(rsProduct__MMColParam, "'", "''") + " and groupid='RPA'  ORDER BY Prodid DESC"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/products/dressed.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
%> </td>
    ...
    <td width="0" background="../img/line.gif"><img width="1" height="25"></td>
  </tr>
</table>
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
