...
rsProduct.Source = "SELECT thumb,name,detail  FROM dbo.product  WHERE groupid ='Feed'  ORDER BY prodid desc"
...
%>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="72%" valign="top"><%=(rsProduct.Fields.Item("detail").Value)%></td>
          <td width="3%">&nbsp;</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="76%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><strong><%=(rsNews.Fields.Item("Title").Value)%></strong></td>
              </tr>
              <tr> 
