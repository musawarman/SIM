...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/products/dressed.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif">&nbsp;&nbsp;&nbsp;&nbsp;PT 
      Sierad Produce Tbk adalah gabungan dari 4 perusahaan pada tahun 2001 yang 
      bergerak di satu bidang bisnis utama di bawah naungan Sierad Group. Empat 
      perusahaan ini adalah PT Anwar Sierad Tbk, PT Sierad Produce Tbk, PT Sierad 
      Feedmill dan PT Sierad Grains.</td>
    ...
    <td valign="top" background="../business/img/bg_bottom.gif"> <div align="left"></div>
      <div align="left">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <% 
