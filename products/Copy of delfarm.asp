...
rsProduct.Source = "SELECT thumb,name,detail  FROM dbo.product  WHERE groupid ='Delfarm'  ORDER BY prodid desc"
...
%> </td>
    ...
    <td width="325" align="center" valign="top" background="../business/img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
