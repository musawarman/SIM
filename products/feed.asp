...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/products/feed.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif"><img src="img/feed_ttl.gif"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif">&nbsp;&nbsp;&nbsp;&nbsp;Merupakan 
      salah satu divisi Sierad Produce yang mengelola pakan ternak. Feedmill ini 
      mengolah jagung, gandum dan bahan baku lainnya menjadi pakan ternak yang 
      dikonsumsi tidak hanya oleh ayam tetapi juga ikan, itik, dan babi. Produk 
      ini dihasilkan melalui berbagai tahapan, mulai dari analisis nutrisi yang 
      terkandung dalam bahan baku, formulasi nutrisi, proses pembuatan pakan, 
      pengujian pembuatan pakan sampai pada program pemberian pakan. Pakan ternak 
      yang higienis dan teruji kualitasnya kemudian didistribusikan ke farm-farm 
      Sierad Produce dan pasar-pasar lokal dan internasional. 
      <p>Sejak 
        produk pakan ternak dipasarkan pada tahun 1994, sebagian pendapatannya 
        digunakan untuk mendukung kegiatan bisnis Sierad Produce lainnya. Produksi 
        pakan ternak ini memakai teknologi canggih dengan menggunakan tiga komputer 
        untuk mengontrol produksi pakan ternak yang berlokasi di Balaraja, Jawa 
        Barat, Sidoardjo, Jawa Timur dan Lampung, Sumatra Utara. Masing-masing 
        lokasi memiliki kapasitas hampir 1 juta metrik ton setiap tahunnya. </p>
      <p>Perluasan proses produksi akan menghasilkan produk-produk higienis yang 
        bersaing dan lebih efisien mengingat pakan ternak Sierad Produce merupakan 
        salah satu pilihan peternak ayam.<br>
        Bahan baku yang digunakan untuk memproduksi pakan ternak antara lain jagung, 
        kedelai, gandum, kulit padi, tapioka, dan lain-lain. Bahan-bahan itu dibeli 
        dari pasar lokal maupun internasional. Pembuatan setiap jenis pakan diformulasikan 
        oleh para ahli nutrisi sesuai dengan umur ternak. Produk yang dihasilkan 
        harus memiliki nutrisi yang cukup namun efisien dan harganya terjangkau 
        sesuai kebutuhan peternak.</p></td>
    ...
    <td valign="top" background="../business/img/bg_bottom.gif"> <div align="left">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <% 
