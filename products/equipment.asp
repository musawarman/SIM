...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="125"><a href="dressed.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image48','','img/top_mn_on_05.gif',1)"><img src="img/top_mn-05.gif" alt="Dressed Chicken" name="Image48" width="150" height="25" border="0"></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/products/equipment.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif">&nbsp;&nbsp;Sesuai 
      dengan nama yang disandangnya, unit usaha ini memproduksi aneka perlengkapan 
      peternakan, seperti: tempat makan ayam, tempat minum ayam, tempat telur, 
      keranjang ayam dan lantai (slat) plastik. Proses produksi di pabrik diawali 
      oleh persiapan perencanaan produksi. Bahan baku yang sudah melalui proses 
      crusser dan mixer dikirim ke bagian produksi. Bahan-bahan tersebut diproses 
      ke mesin mould atau injection sesuai jenis barang yang hendak diproduksi. 
      Segera setelah menjadi barang jadi, bagian quality control melakukan pengecekan. 
      Selanjutnya, barang dikirim ke Gudang Finish Good. Bagian inilah yang kemudian 
      siap melayani permintaan konsumen.
      <p>Sebagai importer, produsen dan distributor peralatan hewan berlokasi 
        di kawasan industri Cikande. <br>
        Alamat : JL Modern Industri No.24, Cikande-Serang, Banten<br>
        Telp : (0254) 402536-37<br>
        Fax : (0254) 402538<br>
        <br>
      </p>
      <p> </p>
