...
rsProduct.Source = "SELECT thumb,name,detail  FROM dbo.product  WHERE groupid ='industri'  ORDER BY prodid desc"
...
rsNews.Source = "SELECT thumbnail,tgl,title,clip  FROM dbo.news  ORDER BY tgl desc"
rsNews.CursorType = 0
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="546" valign="top" background="../business/img/bg_bottom.gif"> <% 
