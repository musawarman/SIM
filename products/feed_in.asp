...
If (Request.QueryString("Prodid") <> "") Then 
  rsProduct__MMColParam = Request.QueryString("Prodid")
End If
%>
<%
Dim rsProduct
...
rsProduct.Source = "SELECT prodid, image,name,lead,detail,tabel  FROM dbo.product  WHERE groupid ='Feed' and Prodid = " + Replace(rsProduct__MMColParam, "'", "''") + "  ORDER BY Prodid DESC"
...
<body background="../business/img/bg.gif" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('img/top_mn_on_01.gif','img/top_mn_on_02.gif','img/top_mn_on_03.gif','img/top_mn_on_04.gif','img/top_mn_on_06.gif','../business/img/mn_on_1.jpg','../business/img/mn_on_2.jpg','../business/img/mn_on_3.jpg','../business/img/mn_on_4.jpg','../business/img/mn_on_5.jpg','../business/img/mn_on_6.jpg','../business/img/mn_on_7.jpg','../business/img/mn_on_8.jpg','../business/img/bg_mid_on__13.jpg','../business/img/bg_mid_on__14.jpg','img/top_mn_on_05.gif')">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/products/feed.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="1" height="105" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
    <td width="47" background="../business/img/bg_bottom.gif">&nbsp;</td>
    <td width="577" valign="top" background="../business/img/bg_bottom.gif"> <% 
...
%>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><%=(rsProduct.Fields.Item("detail").Value)%></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
...
%>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="21%" valign="top"><img src="<%=(rsNews.Fields.Item("thumbnail").Value)%>"></td>
...
Wend
%> </td>
    <td width="9" valign="top" background="../business/img/bg_bottom.gif">
<div align="right"></div></td>
    <td width="21" background="../business/img/bg_bottom.gif">&nbsp;</td>
    <td width="0" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
  </tr>
</table>
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
