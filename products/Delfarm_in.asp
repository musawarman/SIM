...
rsProduct.Source = "SELECT prodid, image,name,lead,detail,tabel  FROM dbo.Product  WHERE Prodid = "+ rsProduct__MMColParam.replace(/'/g, "''") + " and groupid='Delfarm'  ORDER BY Prodid DESC";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../eng/products/delfarm.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
