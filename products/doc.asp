...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="125"><a href="dressed.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image50','','img/top_mn_on_05.gif',1)"><img src="img/top_mn-05.gif" alt="Dressed Chicken" name="Image50" width="150" height="25" border="0"></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/products/doc.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif">&nbsp;&nbsp;&nbsp; 
      Breeding farm yang kami miliki terletak jauh dari area pemukiman di daerah 
      Jawa Barat yang sejuk. Pabrik tempat menampung ayam betina dewasa dirancang 
      sesuai sistem closed-house dengan peralatan modern seperti kipas pendingin, 
      mesin pakan otomatis dan sistem nipple drinking. Sierad Produce menjalankan 
      12 breeding farm yang sebagian besar terletak di Jawa Barat. Total produksi 
      dari seluruh lahan tersebut mencapai lebih dari 120 juta anak ayam (DOC) 
      per tahun, memenuhi kebutuhan internal bisnis Sierad Produce dan pasar eksternal 
      ...
      <p>PROSES PRODUKSI<br>
        a. Pengembangbiakan<br>
        Persiapan secara ekstensif dilakukan untuk menyediakan ruang yang bersih, 
        higienis dan hangat bagi induk-induk ayam baru. Temperatur ruang dan kebersihan 
        dimonitor secara teratur sementara minuman dan pakan khusus tetap diberikan.<br>
        b. Produksi Telur <br>
        Induk mulai memproduksi telur setelah 24 minggu. Selama 42 minggu berikutnya, 
        setiap induk mampu menetaskan sekitar160 butir telur.<br>
        c. Vaksinasi <br>
        Program-program kesehatan untuk semua breeding farm dilaksanakan secara 
        teratur sesuai jadwal yang ditentukan.</p>
      <p>FASILITAS <br>
        Laboratorium<br>
        ...
        untuk menentukan pengobatan yang tepat.</p>
      <p>LOKASI<br>
        1. Farm 1<br>
        Desa Kadusirung, Legok, Tangerang</p>
      <p>2. Farm 2 <br>
        Desa Lumpang, Parung Panjang, Bogor</p>
      <p>3. Prihadi 1<br>
        Desa Ciberang Pondok, Kecamatan Ciawi, Bogor</p>
      <p>4. Prihadi 2<br>
        Desa Ciangsana, Cibadak, Sukabumi</p>
      <p>5. Prihadi 3<br>
        Desa Ciamber, Ngarak, Sukabumi</p>
      <p>6. Prihadi 4<br>
        Desa Gunung Guruh, Cisaat, Sukabumi</p>
      <p>7. TCU<br>
        Desa Argapura, Cigudeg, Bogor</p>
      <p>8. Pontianak<br>
        Jl. S. Pinyuh, Ngabang, Kecamatan Mandor, Kabupaten Pontianak, Kalimantan 
        Barat</p>
      <p>9. SG1<br>
        Desa Cikujang, Cisaat, Sukabumi</p>
      <p>10. SG2<br>
        Desa Cijulang, Jampang Tengah, Sukabumi</p>
      <p>11. SG3<br>
        Kp. Cimuning, Desa Cijulang, Kecamatan Jampang, Sukabumi</p>
      <p>12. SG4<br>
        Kp. Cimuning Desa Cijulang Kecamatan Jampang Sukabumi </p>
      <p>13. SG5<br>
        Kp. Cimuning Desa Cijulang Kecamatan Jampang Sukabumi<br>
      </p></td>
    ...
    <td width="179" valign="top" background="../business/img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <% 
