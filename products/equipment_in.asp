...
rsProduct.Source = "SELECT prodid, image,name,lead,detail,tabel  FROM dbo.Product  WHERE Prodid = " + Replace(rsProduct__MMColParam, "'", "''") + " and groupid='Industri'  ORDER BY Prodid DESC"
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/products/equipment.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="45" background="../business/img/bg_bottom.gif">&nbsp;</td>
    <td width="546" valign="top" background="../business/img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
    ...
    <td width="24" background="../business/img/bg_bottom.gif"><p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p></td>
    <td width="1" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
    <td width="23" background="../business/img/bg_bottom.gif">&nbsp;</td>
...
Wend
%> </td>
    <td width="17" background="../business/img/bg_bottom.gif">&nbsp;</td>
