...
rsCareers.Source = "SELECT tgl,JobTitle, Qualification, Deadline  FROM dbo.Careers  ORDER BY tgl DESC";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="#" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"> <% while ((Repeat1__numRows-- != 0) && (!rsCareers.EOF)) { %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="5%" bgcolor="#CCCC99"> <div align="center"><strong>::</strong></div></td>
          <td width="95%" bgcolor="#CCCC99"><strong><%=(rsCareers.Fields.Item("JobTitle").Value)%></strong><em><font color="#000000">(Posting Date :<%= DoDateTime((rsCareers.Fields.Item("tgl").Value), 1, 2057) %>)</font></em></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        ...
        <tr> 
          <td>&nbsp;</td>
          <td><font color="#FF0000"><em>Expired : <%= DoDateTime((rsCareers.Fields.Item("Deadline").Value), 1, 2057) %></em></font></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="252" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><A HREF="../news/News_in.asp?"><strong></strong></A></td>
                </tr>
                <tr> 
                  <td>&nbsp;</td>
                </tr>
