...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/report/commisioners.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif">::<a href="index.asp">Our 
      ...
      ::<a href="YReview.asp">Year in Review</a>:: | ::<a href="outlook2003.htm">Outlook 
      2003</a>:: | ::<a href="Prospect.asp">Prospect</a>:: |::<a href="future.asp">Our 
      Future</a>:: | ::Commisioners &amp; Directors:: | ::<a href="FinancialReport.pdf">Financial 
      Report</a>:: </td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="44" background="../business/img/bg_bottom.gif">&nbsp;</td>
    <td width="539" valign="top" background="../business/img/bg_bottom.gif"> <div align="justify"></div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="25%"><div align="center"><img src="img/mr_AntoniusSujatakc.gif" width="92" height="153"></div></td>
          <td width="2%">&nbsp;</td>
          <td width="20%"><div align="center"><img src="img/mr_Johankc.gif" width="92" height="154"></div></td>
          <td width="3%">&nbsp;</td>
          <td width="24%"><div align="center"><img src="img/mrs_Belindakc.gif" width="92" height="154"></div></td>
          <td width="2%">&nbsp;</td>
          <td width="24%"> <div align="center"><img src="img/mrs_SriLestarikc.gif" width="92" height="153"></div></td>
        </tr>
        <tr> 
          <td valign="top"> <div align="center"> 
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr> 
                  <td><div align="center">Antonius Sujata, SH.</div></td>
                </tr>
                <tr> 
                  <td><div align="center">President Commisioner</div></td>
                </tr>
              </table>
            </div></td>
          <td>&nbsp;</td>
          <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="center">DR. Johan Effendy</div></td>
              </tr>
              <tr> 
                <td valign="top"><div align="center">Commisioner</div></td>
              </tr>
            </table></td>
          <td>&nbsp;</td>
          <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td valign="top"><div align="center">Belinda Tek Lu Bi Lien</div></td>
              </tr>
              <tr> 
                <td valign="top"><div align="center">Commisioner</div></td>
              </tr>
          ...
          <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td valign="top"><div align="center">Sri Lestari Anwar</div></td>
              </tr>
              <tr> 
                <td><div align="center">Commisioner</div></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
        ...
        <tr> 
          <td><div align="center"><img src="img/mr_Budiardjokc.gif" width="93" height="154"></div></td>
          <td>&nbsp;</td>
          <td><div align="center"><img src="img/mr_Popokc.gif" width="92" height="154"></div></td>
          <td>&nbsp;</td>
          <td><div align="center"><img src="img/mr_awikc.gif" width="93" height="153"></div></td>
          <td>&nbsp;</td>
          <td><div align="center"><img src="img/mr_AntonSupitkc.gif" width="93" height="154"></div></td>
        </tr>
        <tr> 
          <td valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="center">Budiardjo Tek</div></td>
              </tr>
              <tr> 
                <td valign="top"> <div align="center">President Director</div></td>
              </tr>
            </table></td>
          <td>&nbsp;</td>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td valign="top">Rodolfo P Pantoja</td>
              </tr>
              <tr> 
                <td valign="top"> <div align="center">Director</div></td>
              </tr>
            </table></td>
          <td>&nbsp;</td>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="center">F.X. Awi Tantra</div></td>
              </tr>
              <tr> 
                <td valign="top"> <div align="center">Director</div></td>
              </tr>
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="center">Antonius Yunus Supit</div></td>
              </tr>
              <tr> 
                <td valign="top"> <div align="center">Director</div></td>
              </tr>
    ...
    <td width="30" background="../business/img/bg_bottom.gif">&nbsp;</td>
    <td width="1" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
    <td width="22" background="../business/img/bg_bottom.gif">&nbsp;</td>
...
%>
    ...
    <td width="38" background="../business/img/bg_bottom.gif">&nbsp;</td>
    <td width="6" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
  </tr>
</table>
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
