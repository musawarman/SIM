...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/report/prospect.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif">::<a href="index.asp">Our 
      Credo</a>:: | ::<a href="shareholder.htm">Report to Shareholders</a>:: | 
      ::<a href="YReview.asp">Year in Review</a>:: | ::<a href="outlook2003.asp">Outlook 
      2003</a>:: | ::Prospect:: |::<a href="future.asp">Our Future</a>:: | ::<a href="commisioners.asp">Commisioners 
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"> <div align="justify"><strong>Breeding</strong><br>
        In the months ahead, the domestic poultry industry will continue to face 
        a host of challenges. The unusually high sales prices of broiler and layer 
        DOCs in 2002 cannot be sustained nor will they be repeated in 2003. A 
        major integrator has since resolved its past problems and has resumed 
        normal production. In fact , the pendulum, especially for the broiler 
        market, will most certainly swing towards increased production thus the 
        seasonal drop in demand in the first quarter will likely lead to oversupply 
        and depressed sales prices, a condition that may continue for most of 
        the first quarter before demand recovers. Due to the nature of the industry 
        there is also an ever-present risk of disease that can reduce the production 
        of eggs, increase production costs, or even compel the destruction of 
        an entire breeder population. This risk underscores the importance of 
        careful breed selection, professional farm management and strict bio security. 
        <p><strong>Markets</strong><br>
          While the current industry recovery is expected to progress, the continuing 
          overcapacity in milling and DOC production may again lead to oversupply 
          and cutthroat price competition. Moreover, the majority of local farms 
          are still predominantly traditional and unable to raise birds that are 
          internationally cost-competitive. There is also a preference amongst 
          consumers in Indonesia for lighter or smaller birds due to a number 
          of determining factors including disposable income, limited refrigeration 
          and storage facilities, and inefficient distribution systems.</p>
        <p><strong>Trade Liberalization</strong><br>
          The threat of trade liberalization and the entry of poultry products 
          from traditional exporters such as Thailand, the United States, and 
          Brazil may negatively impact the vulnerable domestic poultry industry, 
          which is only beginning to emerge from the setbacks that has plagued 
          it since the onset of the regional economic crisis five years ago. Total 
          domestic demand and per capita poultry consumption in 2002 are only 
          marginally ahead of their 1997 peak.</p>
        <p><strong>Economic Factors</strong><br>
          Supply is threatened by increasing production costs notably fuel and 
          energy, transport, telecommunications and double-digit growth in the 
          minimum wage in some parts of the country, while demand remains vulnerable 
          to declining purchasing power on account of rising living costs, and 
          to global developments that server to stifle consumption.</p>
        <p></p>
      </div>
    ...
    <td width="325" valign="top" background="../business/img/bg_bottom.gif"> <% while ((Repeat1__numRows-- != 0) && (!rsNews.EOF)) { %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
