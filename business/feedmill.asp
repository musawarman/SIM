...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/business/feedmill.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="img/bg_line.gif"><img src="img/feedmill_ttl.gif"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td>Sejak feed mill yang pertama mulai berproduksi pada tahun 1994, 
            produksi makanan ternak telah menjadi usaha inti Sierad Produce, yang 
            berpengaruh signifikan baik dalam hal pendapatan maupun untuk mendukung 
            cabang usaha yang lain. Produksi pakan ternak menerapkan teknologi 
            yang relatif tinggi.<br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Sierad Produce 
            mengoperasikan 3 penggilingan pakan ternak modern berbasis komputer 
            yang terletak di Balaraja, Jawa Barat; Sidoarjo, Jawa Timur dan Lampung, 
            Sumatera Selatan. Kapasitas produksi dari ketiga penggilingan pakan 
            ternak tersebut adalah sebesar 1 juta metrik ton per tahun. Penggunaan 
            Expander dalam proses produksi menghasilkan keuntungan lebih yang 
            menjamin hasil yang lebih higienis, mudah dicerna, dan lebih efisien. 
            Kelebihan ini mengakibatkan pakan ternak yang dihasilkan Sierad Produce 
            menjadi pilihan sebagian besar peternak ayam. <br> <br> &nbsp;&nbsp;&nbsp;&nbsp;Bahan 
            baku yang digunakan terdiri dari jagung, kedelai, pollard gandum, 
            kulit padi, tapioka dan bahan lainnya. Semua bahan yang dibutuhkan 
            didapat di pasar lokal dan internasional. Proses pembuatan berbagai 
            jenis pakan ternak dengan komposisi yang berbeda-beda membutuhkan 
            kemahiran ahli nutrisi yang terlatih untuk menghasilkan formula dengan 
            biaya pembuatan rendah dan menjamin terciptanya pakan ternak berkualitas 
            dengan harga bersaing. <br> <br> <b> BALARAJA FEED MILL</b><br>
            Kapasitas Produksi: 60 Ton Per Jam<br> <br> <b> LAMPUNG FEED MILL</b><br>
            Kapasitas Produksi: 30 Ton Per Jam <br>
            Corn Drying Plant Production <br>
            Kapasitas: 100 Tons Per Jam<br> <br> <b> SIDOARJO FEED MILL</b><br>
            Kapasitas Produksi: 120 Ton Per Jam<br> <br> <b> PRODUCT</b><br>
            Broiler feed <br>
            Layer feed <br>
            Breeder feed <br>
            Concentrate feed <br>
            Hog feed <br>
            Quail feed <br>
            Fish feed<br> <br> <b> FASILITAS<br>
            </b>&nbsp;&nbsp;&nbsp;&nbsp;Laboratorium Laboratorium digunakan untuk 
            memeriksa keadaan fisik dan kimia bahan baku, bahan-bahan yang masih 
            dalam proses produksi dan yang sudah jadi. NIRS (Near Infra Red Spectrometer) 
            merupakan peralatan yang digunakan untuk menganalisa kandungan nutrisi 
            makanan secara cepat.<br> <br> <b> Panel Kontrol</b><br> &nbsp;&nbsp;&nbsp;&nbsp;Panel 
            Kontrol dengan sistem komputerisasi dipergunakan untuk memonitor seluruh 
            proses produksi, mulai pencampuran bahan baku hingga pengepakan produk 
            jadi. Panel-panel tersebut memudahkan operator untuk memastikan efisiensi 
            produksi dan kualitas produksi makanan berdasarkan formula yang ditetapkan 
            oleh ahli gizi.<br> <br> <b> Pengering Jagung</b> <br> &nbsp;&nbsp; 
            &nbsp;Pengering jagung berfungsi untuk mengurangi kandungan air dalam 
            jagung yang merupakan bahan baku utama makanan unggas.<br> <br> <b> 
            Silo</b> <br> &nbsp;&nbsp;&nbsp; Silo, dilengkapi dengan termometer, 
            blow dryer, conveyor belt dan disinfectant spraying dipergunakan untuk 
            menjaga kualitas jagung dan bahan makanan lainnya dari pengaruh cuaca 
            dan gangguan binatang.<br> <br> <b> Expander</b> <br> &nbsp;&nbsp;&nbsp; 
            Expander digunakan untuk memasak bahan mentah pada temperatur dan 
            tekanan tinggi dalam waaktu singkat. Alat ini menyempurnakan kualitas 
            makanan dengan cara menghancurkan jamur, bakteri dan serangga. Selain 
            itu alat ini juga berfungsi untuk menghancurkan selulosa dengan proses 
            kimia alami dan memastikan bahwa nilai kandungan vitamin dan mineral 
            tetap konstan.<br> <br> <b> Gudang Penyimpanan</b> <br> &nbsp;&nbsp;&nbsp;&nbsp;Gudang 
            penyimpanan memiliki kapasitas menyimpan bahan baku untuk keperluan 
            produksi hingga 6 bulan. Pengadaan gudang akan sangat membantu kestabilan 
            produksi karena biaya dan ketersediaan bahan baku mudah sekali mengalami 
            perubahan.<br></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
    ...
    <td width="1" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
    <td background="img/bg_bottom.gif"> <div align="left">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
