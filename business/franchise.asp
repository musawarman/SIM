...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/business/franchise.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="90" valign="top" background="img/bg_bottom.gif"> <p align="center"><a href="http://www.hartz.co.id"><img src="img/Hartz1.gif" alt="Go to http://www.hartz.co.id" width="69" height="76" border="0"></a></p>
      <p align="center"><a href="http://www.wendys.co.id"><img src="img/Logowendys1.gif" alt="Go to http://www.wendys.co.id" width="69" height="76" border="0"></a></p></td>
    <td width="561" valign="top" background="img/bg_bottom.gif">&nbsp;&nbsp;&nbsp;&nbsp;Sierad 
      Produce terlibat di dua bidang ritel industri makanan. Lisensi ekslusif 
      diperoleh dari Wendy's Indonesia dan Hartz, restoran &quot;all-you-can-eat&quot; 
      dari Amerika dengan sajian utama ayam untuk wilayah pemasaran Indonesia 
      dan beberapa negara di Asia. <br> <br> &nbsp;&nbsp;&nbsp; Meningkatnya populasi 
      dan pendapatan masyarakat kelas menengah memacu peningkatan konsumsi daging 
      ayam. Alasan-alasan ekonomis, budaya dan religi membuat daging ayam menjadi 
      alternatif konsumsi utama bagi sebagian besar masyarakat Indonesia. Faktor-faktor 
      ini juga berpengaruh signifikan terhadap pertumbuhan restoran cepat saji. 
      Restoran-restoran yang dikelola Sierad Produce memiliki pangsa pasar yang 
      semakin meluas.</td>
