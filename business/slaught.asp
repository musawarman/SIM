...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/business/slaught.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="img/bg_bottom.gif"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td>&nbsp;Hal yang mendapat perhatian utama dalam proses peternakan 
            ayam yang kami laksanakan mencakup pemotongan secara halal dan sesuai 
            persyaratan yang ditentukan oleh pasar. Rumah potong ayam milik Sierad 
            Produce yang sebagian besar termekanisasi terletak di Jabon, Jawa 
            Barat yang memiliki kapasitas potong sebesar 12.000 ayam per hari.<br> 
            <br> <b> PRODUK<br>
            </b>Dressed Chicken <br>
            By-Products <br>
            Value-added Food Products <br>
            Feather Meal<br> <br> <b> PROSES PRODUKSI</b><br>
            a. Rumah Potong Ayam<br>
            Ayam yang masih hidup dihitung kembali, ditimbang dan dijaga dari 
            segala macam penyakit. Ayam-ayam tersebut dibiarkan sekitar 1 jam 
            sebelum kemudian digantung pada alat yang tersedia. Kemudian dilewatkan 
            pada stunner otomatis sebelum akhirnya dipotong sesuai dengan syarat-syarat 
            &quot;halal&quot; menurut syariat Islam. <br>
            b. Evisceration dan Chilling Organ-organ perut dipisahkan dan bagian 
            tubuh yang lain seperti leher dan kepala dijual terpisah sebagai produk 
            sampingan. Daging ayam yang telah dipotong kemudian didinginkan dalam 
            tangki pendingin untuk mencegah berkembangbiaknya bakteri. <br>
            c. Grading dan Cutting Daging ayam yang telah dipotong kemudian digolongkan 
            berdasarkan bobot dan kualitas. Ayam dipotong sesuai dengan selera 
            konsumen, seperti utuh tanpa kepala dan kaki, tanpa tulang, terpisah 
            antara badan, kaki dan sayap, dan sebagainya.<br> <br> <b> FASILITAS</b><br>
            a. Blast Freezer, Ruang Pendingin dan Pengiriman<br>
            Blast Freezer digunakan untuk membekukan daging ayam dalam waktu singkat 
            dengan suhu mencapai minus 35 derajat Celcius. Di dalam ruang pendingin, 
            stok dapat disimpan hingga satu tahun dengan temperatur di bawah minus 
            20 derajat Celcius.<br> <br>
            Pengiriman dilakukan dengan menggunakan truk berpendingin dengan temperatur 
            yang dapat diatur. <br> <br>
            b. Laboratorium <br>
            Laboratorium digunakan untuk memfasilitasi program kesehatan dan dilaksanakan 
            di semua breeding farm. Ayam yang tidak sehat diperiksa di laboratorium 
            untuk diberikan pengobatan yang tepat.<br> <br>
            c. Pengolahan Limbah Air dan Pemrosesan Feather Meal<br>
            Limbah cair hasil pengolahan produk ayam diproses dengan fasilitas 
            pengolahan limbah air berkapasitas pemrosesan 700.000 liter per hari. 
            Fasilitas ini memenuhi standar manajemen pengolahan air limbah yang 
            ditetapkan pemerintah.<br> <br>
            Fasilitas feather meal digunakan untuk memproses limbah padat seperti 
            bulu ayam menjadi produk layak jual, misalnya sebagai bahan baku pakan 
            ternak.</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
    ...
    <td width="1" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
    <td background="img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
