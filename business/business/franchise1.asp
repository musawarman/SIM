...
rsProfile.Source = "SELECT *  FROM dbo.profile  WHERE compid='Wendys' and lang='Indonesia'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../eng/business/franchise1.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="502" valign="top" background="img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
      ...
      <br> </td>
    <td width="23" background="img/bg_bottom.gif">&nbsp;</td>
    <td width="1" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
    <td width="22" background="img/bg_bottom.gif">&nbsp;</td>
    <td width="309" valign="top" background="img/bg_bottom.gif"> 
      <div align="right"> 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            <td valign="top">&nbsp;</td>
            <td>&nbsp;</td>
            <td> <div align="right"><A HREF="../news/News_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsNews.Fields.Item("ID").Value %>"><%=(rsNews.Fields.Item("lengkap").Value)%></A></div>
              </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
...
%>
    ...
    <td width="37" background="img/bg_bottom.gif">&nbsp;</td>
    <td width="3" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
  </tr>
</table>
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
