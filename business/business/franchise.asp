...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/business/franchise.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="90" valign="top" background="img/bg_bottom.gif">
<p align="center"><a href="http://www.hartz.co.id"><img src="img/Hartz1.gif" alt="Go to http://www.hartz.co.id" width="69" height="76" border="0"></a></p>
