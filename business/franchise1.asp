...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="95"><a href="franchise1.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','img/top_mn_on_06.gif',1)"><img src="img/top_mn-06.gif" alt="Wendy's" name="Image8" width="95" height="25" border="0"></a></td>
    <td width="75"><a href="franchise2.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','img/top_mn_on_07.gif',1)"><img src="img/top_mn-07.gif" alt="Hartz" name="Image9" width="75" height="25" border="0"></a></td>
    <td width="457"><img src="img/bg_mn_top_r1.gif" width="457" height="25"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="index.asp"><img src="img/bg_mid__9.jpg" alt="Divisi Poultry" width="155" height="40" border="0"></a></td>
    ...
    <td><a href="../eng/business/franchise1.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="img/bg_line.gif"><img src="img/wendys_ttl.gif" width="118" height="21"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="90" valign="top" background="img/bg_bottom.gif"> <div align="center"><a href="http://www.wendys.co.id"><img src="img/Logowendys1.gif" alt="Go to http://www.wendys.co.id" width="69" height="76" border="0"></a></div></td>
    <td width="561" valign="top" background="img/bg_bottom.gif"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td>&nbsp;&nbsp;Sierad Produce mendapatkan lisensi untuk restoran waralaba 
            Wendy's pada tahun 1995. Pada saat itu hanya terdapat sebelas outlet 
            Wendy's di seluruh Indonesia. Di bawah manajemen Sierad Produce, jumlah 
            ini terus meningkat hingga mencapai lebih dari empat puluh outlet 
            sebelum terjadinya krisis ekonomi.<br> <br> &nbsp;&nbsp;&nbsp; Krisis 
            ekonomi yang terjadi di Indonesia mempengaruhi daya beli masyarakat, 
            yang mengakibatkan ditutupnya beberapa outlet Wendy's. Umumnya outlet 
            yang ditutup berlokasi di perkantoran atau gedung-gedung komersial. 
            Berkurangnya penghuni di perkantoran-perkantoran tersebut berdampak 
            langsung pada penurunan penjualan di outlet-outlet kami. Namun demikian, 
            Wendy's tetap menikmati keuntungan dari segi pemasaran, termasuk kuatnya 
            brand image di kalangan pelanggan dan reputasi yang baik dalam hal 
            kualitas, nilai produk dan standar layanan tinggi.<br> <br> &nbsp;&nbsp;&nbsp; 
            Perusahaan telah melakukan upaya tertentu guna memenuhi cita rasa 
            lokal dengan menciptakan beragam inovasi dan menawarkan menu yang 
            lebih bervariasi.<br> <br> &nbsp;&nbsp;&nbsp; Komitmen manajemen atas 
            kualitas terlihat dari berbagai penghargaan yang diberikan oleh Wendy's 
            USA kepada pelaksana lokal di Indonesia. Kategori penilaian untuk 
            penerima penghargaan tersebut meliputi bidang pelayanan, kebersihan, 
            kualitas makanan dan sebagainya.</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
    ...
    <td valign="top" background="img/bg_bottom.gif"> <div align="left">&nbsp;
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
