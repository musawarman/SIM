...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/business/franchise2.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="170"><a href="../report/index.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image36','','img/mn_on_7.jpg',1)"><img src="img/mn_7.jpg" alt="Laporan Tahunan" name="Image36" width="170" height="30" border="0"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="img/bg_line.gif"><img src="img/hartz_ttl.gif" width="90" height="21"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="90" valign="top" background="img/bg_bottom.gif"> <div align="center"><a href="http://www.hartz.co.id"><img src="img/Hartz1.gif" alt="Go to http://www.hartz.co.id" width="69" height="76" border="0"></a></div></td>
    <td width="561" valign="top" background="img/bg_bottom.gif"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td>Sierad Produce telah melepaskan hak sebagai pemilik saham terbesar 
            Hartz USA, perusahaan waralaba dan pemegang lisensi buffet restaurants 
            yang menjual ayam panggang, ayam goreng dan berbagai makanan berbahan 
            dasar ayam lainnya. Namun, kami tetap memegang hak lisensi ekslusif 
            untuk pemasaran produk Hartz di Indonesia dan beberapa negara di Asia. 
            <br> <br> &nbsp;&nbsp;&nbsp; Kami percaya bahwa metode penjualan Hartz, 
            dimana pelanggan membayar harga yang cukup murah untuk sistem &quot;semua 
            bisa Anda makan&quot;, dan buffet swalayan cukup memiliki potensi 
            baik di Indonesia. Selain itu, usaha penjualan produk makanan berbahan 
            ayam yang dilakukan Hartz seiring dengan inti usaha Sierad Produce.</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
