...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/business/breeding.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="img/bg_line.gif"><img src="img/breeding_ttl.gif"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td>Breeding farm yang kami miliki terletak jauh dari area pemukiman 
            di daerah Jawa Barat yang sejuk. Pabrik tempat menampung ayam betina 
            dewasa dirancang sesuai sistem closed-house dengan peralatan modern 
            seperti kipas pendingin, mesin pakan otomatis dan sistem nipple drinking. 
            Sierad Produce menjalankan 12 breeding farm yang sebagian besar terletak 
            di Jawa Barat. Total produksi dari seluruh lahan tersebut mencapai 
            lebih dari 120 juta anak ayam (DOC) per tahun, memenuhi kebutuhan 
            internal bisnis Sierad Produce dan pasar eksternal baik dalam negeri 
            maupun ekspor.<br> <br> <b> PRODUK<br>
            </b>Broiler DOC <br>
            Layer DOC <br>
            Male DOC <br> <br> <br> <b> PROSES PRODUKSI</b><br>
            a. Pengembangbiakan<br>
            Persiapan secara ekstensif dilakukan untuk menyediakan ruang yang 
            bersih, higienis dan hangat bagi induk-induk ayam baru. Temperatur 
            ruang dan kebersihan dimonitor secara teratur sementara minuman dan 
            pakan khusus tetap diberikan.<br>
            b. Produksi Telur <br>
            Induk mulai memproduksi telur setelah 24 minggu. Selama 42 minggu 
            berikutnya, setiap induk mampu menetaskan sekitar160 butir telur.<br>
            c. Vaksinasi <br>
            Program-program kesehatan untuk semua breeding farm dilaksanakan secara 
            teratur sesuai jadwal yang ditentukan.<br> <br> <b> FASILITAS </b><br> 
            <b>Laboratorium</b><br>
            ...
            untuk menentukan pengobatan yang tepat.<br> <br> <b> LOKASI</b><br>
            1. Farm 1<br>
            Desa Kadusirung, Legok, Tangerang<br> <br>
            2. Farm 2 <br>
            Desa Lumpang, Parung Panjang, Bogor<br> <br>
            3. Prihadi 1<br>
            Desa Ciberang Pondok, Kecamatan Ciawi, Bogor<br> <br>
            4. Prihadi 2<br>
            Desa Ciangsana, Cibadak, Sukabumi<br> <br>
            5. Prihadi 3<br>
            Desa Ciamber, Ngarak, Sukabumi<br> <br>
            6. Prihadi 4<br>
            Desa Gunung Guruh, Cisaat, Sukabumi<br> <br>
            7. TCU<br>
            Desa Argapura, Cigudeg, Bogor<br> <br>
            8. Pontianak<br>
            Jl. S. Pinyuh, Ngabang, Kecamatan Mandor, Kabupaten Pontianak, Kalimantan 
            Barat<br> <br>
            9. SG1<br>
            Desa Cikujang, Cisaat, Sukabumi<br> <br>
            10. SG2<br>
            Desa Cijulang, Jampang Tengah, Sukabumi<br> <br>
            11. SG3<br>
            Kp. Cimuning, Desa Cijulang, Kecamatan Jampang, Sukabumi<br> <br>
            12. SG4<br>
            Kp. Cimuning Desa Cijulang Kecamatan Jampang Sukabumi <br> <br>
            13. SG5<br>
            Kp. Cimuning Desa Cijulang Kecamatan Jampang Sukabumi</td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
