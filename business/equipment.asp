...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td><a href="../eng/business/equipment.html" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="1" height="267" background="../img/line.gif"><img src="../img/spacer.gif" width="1" height="25"></td>
    ...
    <td width="561" valign="top" background="img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><p> Poultry Equipment Division (Sierad Industri) terletak di Kawasan 
              Industri Cikande serang Banten dan bergerak pada bidang industri 
              peralatan peternakan untuk pasar lokal dan perdagangan umum. Sierad 
              Industri ini mulai berproduksi secara komersial sejak bulan September 
              1996, Divisi ini memiliki 7 Mesin 5 buah mesin Injection Mould dan 
              2 Mesin Blowing. Produk yang di hasilkan memiliki kualitas yang 
              sangat bagus karena pada proses produksinya dilakukan pengawasan 
              yang ketat, tetapi dengan biaya yang efisien sehingga dapat bersaing 
              dalam harga di pasaran.</p>
            <p>Produk <br>
              Keranjang Ayam Plastik<br>
              Automatic Drinker<br>
              Manual Drinker<br>
              Manual Hanging Feeder<br>
              Manual Chick Feeder Tray<br>
              Band Tray<br>
              Egg Tray<br>
              Keranjang Tetas Hatcher<br>
              Food Case<br>
              Plastik Slat</p>
            <p>Fasilitas</p>
            <p>Sierad Industri Memiliki 7 buah mesin yang terdiri dari 5 mesin 
              injection dan 2 mesin blowing yaitu :<br>
              ...
              1. Blow VK 5 Ltr<br>
              2. Blow VK 10 Ltr<br>
              Semua mesin di atas memiliki kapasitas produksi masing &#8211; masing 
              sesuai dengan barang yang di hasilkan setiap mesin tersebut.</p></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
    ...
    <td valign="top" background="img/bg_bottom.gif"> <div align="right">&nbsp; 
      </div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
