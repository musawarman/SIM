...
<div align="center"> 
  <table width="600" border="0">
    ...
    <tr> 
      <td width="468" height="39"> <div align="left"> 
  ...
  <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
    <table width="384" height="136" border="1" align="center" cellspacing="0" bordercolor="#999999">
      <tr bgcolor="#000099"> 
        <td colspan="2"> <div align="center"> <font color="#FFFFFF" size="3" face="Comic Sans MS">Currency 
            Information</font></div></td>
      </tr>
      <tr bgcolor="#CCCCCC"> 
        <td width="175"> <div align="right" class="style6">Currency ID : </div></td>
      ...
      <tr bgcolor="#CCCCCC"> 
        <td> <div align="right" class="style6">Currency Name : </div></td>
        <td> <div align="left"> 
