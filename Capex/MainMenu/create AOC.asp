...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_editTable = "dbo.AOCHD"
  MM_editRedirectUrl = "create AOCdetail.asp"
  MM_fieldsStr  = "noAoc|value|NoCapex|value|tgglAoc|value|textfield|value|NBarng|value|AocQty|value|AocPrice|value|QtyPrice|value|IdrPrice|value|IdrQtyPrice|value|hiddenField|value"
  MM_columnsStr = "NoAOC|',none,''|NoCapex|',none,''|TglAOC|',none,NULL|StatusAOC|',none,''|AOCNamaBarang|',none,''|AOCQty|none,none,NULL|AOCPrice|none,none,NULL|AOCQTYPrice|none,none,NULL|IDRprice|none,none,NULL|IDRQTYPrice|none,none,NULL|UpdateUsr|',none,''"
...
Dim GetRunNumberAOC__nocapex
GetRunNumberAOC__nocapex = ""
if(session("UpdateNoCapex") <> "") then GetRunNumberAOC__nocapex = session("UpdateNoCapex")

%>
<%

set GetRunNumberAOC = Server.CreateObject("ADODB.Command")
GetRunNumberAOC.ActiveConnection = MM_CapexConn_STRING
GetRunNumberAOC.CommandText = "dbo.P_CreateAutoNumberAOC"
GetRunNumberAOC.Parameters.Append GetRunNumberAOC.CreateParameter("@RETURN_VALUE", 3, 4)
GetRunNumberAOC.Parameters.Append GetRunNumberAOC.CreateParameter("@nocapex", 200, 1,20,GetRunNumberAOC__nocapex)
GetRunNumberAOC.Parameters.Append GetRunNumberAOC.CreateParameter("@NoAoc", 200, 2,20)
GetRunNumberAOC.CommandType = 4
GetRunNumberAOC.CommandTimeout = 0
GetRunNumberAOC.Prepared = true
GetRunNumberAOC.Execute()
                ...
                <table width="806" border="0" align="center" background="../../img/bg.gif">
                  <tr> 
                    <td width="800" height="20"><div align="left"><font color="#FF0000" size="3" face="Courier New, Courier, mono">&gt;&gt; 
                        <strong>PEMBUATAN AOC</strong></font></div></td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    <td height="215"> <div align="center"> 
                        ...
                        <form action="<%=MM_editAction%>" method="POST" name="form1" onSubmit="MM_validateForm('noAoc','','R','NoCapex','','R','tgglAoc','','R','textfield','','R','NBarng','','R','AocQty','','RisNum','AocPrice','','RisNum','QtyPrice','','RisNum','IdrPrice','','RisNum','IdrQtyPrice','','RisNum');return document.MM_returnValue">
                          <table width="740" border="1" bgcolor="#6699FF">
                            <tr> 
                              <td height="23"> <div align="center"><font color="#FFFF00">Create 
                                  AOC</font></div></td>
                            </tr>
                            <tr> 
                              <td><table width="362" border="1" align="center" bgcolor="#CCCCCC">
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">No 
                                        AOC *</font></div></td>
                                    <td><div align="left"> 
                                        <input name="noAoc" id="noAoc" value="<%= GetRunNumberAOC.Parameters.Item("@NoAoc").Value %>" readonly="text">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">No 
                                        Capex *</font></div></td>
                                    <td><div align="left"> 
                                        <input name="NoCapex" reADONLY="text" id="NoCapex" value="<%= Session("Updatenocapex") %>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">Tanggal 
                                        AOC *</font></div></td>
                                    <td> <div align="left"> 
                                        <input name="tgglAoc" readonly="text" id="tgglAoc" value="<%=date%>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">Status 
                                        AOC *</font></div></td>
                                    <td><div align="left"> 
                                        <input readonly="text" name="textfield" value="<%=response.write("Unapprove")%>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">AOCNamaBarang 
                                        *</font></div></td>
                                    <td><input name="NBarng" type="text" id="NBarng"></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">AOC 
                                        QTY *</font></div></td>
                                    <td><input name="AocQty" type="text" id="AocQty"></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">AOC 
                                        Price *</font></div></td>
                                    <td><input name="AocPrice" type="text" id="AocPrice"></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">AOCQTYPrice 
                                        *</font></div></td>
                                    <td><input name="QtyPrice" type="text" id="QtyPrice"></td>
                                  </tr>
                                  <tr> 
                                    <td> <div align="right"><font color="#FF0000">IDRprice 
                                        *</font></div></td>
                                    <td><input name="IdrPrice" type="text" id="IdrPrice"></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">IDRQtyprice 
                                        *</font></div></td>
                                    <td><input name="IdrQtyPrice" type="text" id="IdrQtyPrice"></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="center"> 
