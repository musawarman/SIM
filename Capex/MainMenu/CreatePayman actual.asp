...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "ListPaymentActual.asp"
  MM_fieldsStr  = "PaymentActual|value|TanggalActual|value|select|value|TanggalBPU|value|No BPU|value|BankBPU|value|NoBG_CH|value|DateBG_CH|value|hiddenField|value"
  MM_columnsStr = "PaymentActual|none,none,NULL|TanggalActual|',none,NULL|TypePaymentBG_CH|',none,''|TanggalBPU|',none,NULL|NoBPU|',none,''|BankBPU|',none,''|NOBG_CH|',none,''|Tanggal_JT_BG_CH|',none,NULL|UpdateUsr|',none,''"
...
%>
<%
Dim rsPaymentActual__MMColParam
rsPaymentActual__MMColParam = "1"
If (Request.QueryString("NoID") <> "") Then 
  rsPaymentActual__MMColParam = Request.QueryString("NoID")
End If
%>
<%
Dim rsPaymentActual
Dim rsPaymentActual_numRows

Set rsPaymentActual = Server.CreateObject("ADODB.Recordset")
rsPaymentActual.ActiveConnection = MM_CapexConn_STRING
rsPaymentActual.Source = "SELECT *  FROM dbo.Payment  WHERE NoID = " + Replace(rsPaymentActual__MMColParam, "'", "''") + ""
rsPaymentActual.CursorType = 0
rsPaymentActual.CursorLocation = 2
rsPaymentActual.LockType = 1
rsPaymentActual.Open()

rsPaymentActual_numRows = 0
%>
<%
Dim rsPaymentEstimasi__MMColParam
rsPaymentEstimasi__MMColParam = "1"
If (Request.QueryString("NoID") <> "") Then 
  rsPaymentEstimasi__MMColParam = Request.QueryString("NoID")
End If
%>
<%
Dim rsPaymentEstimasi
Dim rsPaymentEstimasi_numRows

Set rsPaymentEstimasi = Server.CreateObject("ADODB.Recordset")
rsPaymentEstimasi.ActiveConnection = MM_CapexConn_STRING
rsPaymentEstimasi.Source = "SELECT * FROM dbo.Payment WHERE NoID = " + Replace(rsPaymentEstimasi__MMColParam, "'", "''") + ""
rsPaymentEstimasi.CursorType = 0
rsPaymentEstimasi.CursorLocation = 2
rsPaymentEstimasi.LockType = 1
rsPaymentEstimasi.Open()

rsPaymentEstimasi_numRows = 0
%>
<%
...
Repeat1__numRows = 5
Repeat1__index = 0
rsPaymentEstimasi_numRows = rsPaymentEstimasi_numRows + Repeat1__numRows
%>
<%
'  *** Recordset Stats, Move To Record, and Go To Record: declare stats variables

Dim rsPaymentEstimasi_total
Dim rsPaymentEstimasi_first
Dim rsPaymentEstimasi_last

' set the record count
rsPaymentEstimasi_total = rsPaymentEstimasi.RecordCount

' set the number of rows displayed on this page
If (rsPaymentEstimasi_numRows < 0) Then
  rsPaymentEstimasi_numRows = rsPaymentEstimasi_total
Elseif (rsPaymentEstimasi_numRows = 0) Then
  rsPaymentEstimasi_numRows = 1
End If

' set the first and last displayed record
rsPaymentEstimasi_first = 1
rsPaymentEstimasi_last  = rsPaymentEstimasi_first + rsPaymentEstimasi_numRows - 1

' if we have the correct record count, check the other stats
If (rsPaymentEstimasi_total <> -1) Then
  If (rsPaymentEstimasi_first > rsPaymentEstimasi_total) Then
    rsPaymentEstimasi_first = rsPaymentEstimasi_total
  End If
  If (rsPaymentEstimasi_last > rsPaymentEstimasi_total) Then
    rsPaymentEstimasi_last = rsPaymentEstimasi_total
  End If
  If (rsPaymentEstimasi_numRows > rsPaymentEstimasi_total) Then
    rsPaymentEstimasi_numRows = rsPaymentEstimasi_total
  End If
End If
%>
...
Set MM_rs    = rsPaymentEstimasi
MM_rsCount   = rsPaymentEstimasi_total
MM_size      = rsPaymentEstimasi_numRows
MM_uniqueCol = ""
MM_paramName = ""
MM_offset = 0
MM_atTotal = false
...
' set the first and last displayed record
rsPaymentEstimasi_first = MM_offset + 1
rsPaymentEstimasi_last  = MM_offset + MM_size

If (MM_rsCount <> -1) Then
  If (rsPaymentEstimasi_first > MM_rsCount) Then
    rsPaymentEstimasi_first = MM_rsCount
  End If
  If (rsPaymentEstimasi_last > MM_rsCount) Then
    rsPaymentEstimasi_last = MM_rsCount
  End If
End If
                ...
                <table width="800" border="0" align="center" background="../../img/bg.gif">
                  ...
                  <tr> 
                    <td height="215"> <div align="center"> 
                        ...
                        <p>&nbsp;</p>
                        <div align="left"></div>
                        <table width="740" border="1" bordercolor="#FF9900">
                          <tr bgcolor="#6699FF"> 
                            <td><div align="center"><font color="#FFFFFF">No ID</font></div></td>
                            <td> <div align="center"><font color="#FFFFFF">NoAOC</font></div></td>
                            <td> <div align="center"><font color="#FFFFFF">PaymentSeq</font></div></td>
                            <td> <div align="center"><font color="#FFFFFF">PaymentDescription</font></div></td>
                            <td> <div align="center"><font color="#FFFFFF">PaymentPercent</font></div></td>
                            <td> <div align="center"><font color="#FFFFFF">PaymentEstimasi</font></div></td>
                            <td> <div align="center"><font color="#FFFFFF">TanggalEstimasi</font></div></td>
                            <td> <div align="center"><font color="#FFFFFF">Post 
                                By</font></div></td>
                          </tr>
                          <% While ((Repeat1__numRows <> 0) AND (NOT rsPaymentEstimasi.EOF)) %>
                          <tr bgcolor="#CCCCCC"> 
                            <td><div align="center"><%=(rsPaymentEstimasi.Fields.Item("NoID").Value)%></div></td>
                            <td> <div align="center"><%=(rsPaymentEstimasi.Fields.Item("NoAOC").Value)%></div></td>
                            <td> <div align="center"><%=(rsPaymentEstimasi.Fields.Item("PaymentSeq").Value)%></div></td>
                            <td> <div align="center"><%=(rsPaymentEstimasi.Fields.Item("PAymenyDesc").Value)%></div></td>
                            <td> <div align="center"><%=(rsPaymentEstimasi.Fields.Item("PaymentPrcn").Value)%></div></td>
                            <td> <div align="center"><%=(rsPaymentEstimasi.Fields.Item("PaymentEstimasi").Value)%></div></td>
                            <td> <div align="center"><%=(rsPaymentEstimasi.Fields.Item("TanggalEstimasi").Value)%></div></td>
                            <td> <div align="center"><%=(rsPaymentEstimasi.Fields.Item("UpdateUsr").Value)%></div></td>
                          </tr>
                          <% 
  Repeat1__index=Repeat1__index+1
  Repeat1__numRows=Repeat1__numRows-1
  rsPaymentEstimasi.MoveNext()
Wend
%>
                        </table>
                        ...
                        <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" onSubmit="MM_validateForm('PaymentActual','','RisNum','TanggalActual','','R','TanggalBPU4','','R','No BPU','','R','BankBPU','','R','NoBG_CH','','R');return document.MM_returnValue">
                          <p>&nbsp;</p>
                          <table width="740" border="0">
                            <tr> 
                              <td><table width="522" border="1" align="center" bgcolor="#CCCCCC">
                                  <tr> 
                                    <td width="222"><div align="right">NoID *</div></td>
                                    <td width="284"> <div align="left"> 
                                        <input name="NoID" readonly="text" id="NoID" value="<%=(rsPaymentActual.Fields.Item("NoID").Value)%>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right">Payment Actual *</div></td>
                                    <td> <div align="left"> 
                                        <input name="PaymentActual" type="text" id="PaymentActual">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right">Tanggal Actual *</div></td>
                                    <td> <div align="left"> 
                                        <input name="TanggalActual" type="text" id="TanggalActual">
                                        format : mm/dd/yyyy</div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right">Type Payment BG_CH 
                                        *</div></td>
                                    <td> <div align="left"> 
                                        <select name="select" size="1">
                                          <option value="BG" <%If (Not isNull((rsPaymentActual.Fields.Item("TypePaymentBG_CH").Value))) Then If ("BG" = CStr((rsPaymentActual.Fields.Item("TypePaymentBG_CH").Value))) Then Response.Write("SELECTED") : Response.Write("")%>>Bilyet/Giro</option>
                                          <option value="CH" <%If (Not isNull((rsPaymentActual.Fields.Item("TypePaymentBG_CH").Value))) Then If ("CH" = CStr((rsPaymentActual.Fields.Item("TypePaymentBG_CH").Value))) Then Response.Write("SELECTED") : Response.Write("")%>>Cheque</option>
                                        </select>
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td> <div align="right">Tanggal BPU *</div></td>
                                    <td> <div align="left"> 
                                        <input name="TanggalBPU" type="text" id="TanggalBPU4">
                                        format : mm/dd/yyyy</div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right">No BPU *</div></td>
                                    <td><div align="left"> 
                                        <input name="No BPU" type="text" id="No BPU">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right">Bank BPU *</div></td>
                                    <td> <div align="left"> 
                                        <input name="BankBPU" type="text" id="BankBPU">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right">No BG_CH *</div></td>
                                    <td> <div align="left"> 
                                        <input name="NoBG_CH" type="text" id="NoBG_CH">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td height="28"> <div align="right">Tanggal 
                                        Jatuh Tempo BG_CH *</div></td>
                                    <td><div align="left"> 
                                        <input name="DateBG_CH" type="text" id="DateBG_CH">
                                      </div></td>
                                  </tr>
                                  <tr> 
                          ...
                          <input type="hidden" name="MM_recordId" value="<%= rsPaymentActual.Fields.Item("NoID").Value %>">
...
<%
rsPaymentActual.Close()
Set rsPaymentActual = Nothing
%>
<%
rsPaymentEstimasi.Close()
Set rsPaymentEstimasi = Nothing
%>
