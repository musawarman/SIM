...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editColumn = "NoCapex"
  MM_recordId = "'" + Request.Form("MM_recordId") + "'"
  MM_editRedirectUrl = " browse CapexStatus.asp"
  MM_fieldsStr  = "NoCapex|value|select|value|HoldBy|value|Reason|value"
  MM_columnsStr = "NoCapex|',none,''|StatusCapex|',none,''|Hold_Capex_By|',none,''|Hold_Reason|',none,''"
...
rsCapexHD.Source = "SELECT NoCapex, StatusCapex, UpdateUsr, Hold_Capex_By, Hold_Reason FROM dbo.CapexHD WHERE NoCapex = '" + Replace(rsCapexHD__MMColParam, "'", "''") + "'"
                ...
                <table width="806" border="0" align="center" background="../../img/bg.gif">
                  <tr> 
                    <td width="800" height="20"><div align="left"><font color="#FF0000" size="3" face="Courier New, Courier, mono">&gt;&gt; 
                        <strong>HOLD CAPEX</strong></font></div></td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    <td height="215"> <div align="center"> 
                        ...
                        <form action="<%=MM_editAction%>" method="POST" name="form1" onSubmit="MM_validateForm('textarea','','R');return document.MM_returnValue">
                          <table width="527" border="1" align="center" bgcolor="#006600">
                            <tr> 
                              <td height="22"> <div align="right"><font color="#FFFFFF">No 
                                  Capex * </font></div></td>
                              <td> <div align="left"> 
                                  <input name="NoCapex" Readonly="text" id="NoCapex" value="<%=(rsCapexHD.Fields.Item("NoCapex").Value)%>">
                                </div></td>
                            </tr>
                            <tr> 
                              <td height="22"><div align="right"><font color="#FFFFFF">Status 
                                  Capex *</font></div></td>
                              <td><div align="left"> 
                            ...
                            <tr> 
                              <td width="138"><div align="right"><font color="#FFFFFF">Hold 
                                  By *</font></div></td>
                              <td width="373"> <div align="left"> 
                                  <input name="HoldBy" readonly="text" id="HoldBy" value="<%= Session("UpdateUsr") %>">
                                </div></td>
                            </tr>
                            <tr> 
                              <td><div align="right"><font color="#FFFFFF">Reason 
                                  *</font></div></td>
                              <td><div align="left"> 
                                  <textarea name="Reason" cols="40" rows="10" id="textarea"></textarea>
                                </div></td>
                            </tr>
                            <tr> 
                              <td><div align="center"> 
                              ...
                              <td> <div align="right"><span class="style7">Date:</span> 
                                  <%=date%></div></td>
                            </tr>
                          </table>
                          <input type="hidden" name="MM_update" value="form1">
                          <input type="hidden" name="MM_recordId" value="<%= rsCapexHD.Fields.Item("NoCapex").Value %>">
                        </form>
                        <p><img src="../../img/garis1.gif" width="400" height="1"></p>
                      </div></td>
                  </tr>
