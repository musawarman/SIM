...
If (CStr(Request("MM_update")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  MM_editRedirectUrl = "browse AOCStatus.asp"
  MM_fieldsStr  = "NoAOC|value|select|value|HoldBy|value|Reason|value"
  MM_columnsStr = "NoAOC|',none,''|StatusAOC|',none,''|Hold_AOC_By|',none,''|Hold_Reason|',none,''"
...
rsAOCHD.Source = "SELECT NoAOC, StatusAOC, Hold_AOC_By, Hold_Reason FROM dbo.AOCHD WHERE NoAOC = '" + Replace(rsAOCHD__MMColParam, "'", "''") + "'"
                    ...
                    <td height="215"> <div align="center"> 
                        ...
                        <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" onSubmit="MM_validateForm('textarea','','R');return document.MM_returnValue">
                          <table width="527" border="1" align="center" bgcolor="#006600">
                            ...
                            <tr> 
                              <td width="116"><div align="right"><font color="#FFFFFF">Hold 
                                  By *</font></div></td>
                              <td width="395"> <div align="left"> 
                                  <input name="HoldBy" id="HoldBy" value="<%= Session("UpdateUsr") %>" readonly="text">
                                </div></td>
                            </tr>
                            <tr> 
                          ...
                          <input type="hidden" name="MM_recordId" value="<%= rsAOCHD.Fields.Item("NoAOC").Value %>">
                        </form>
                        <p><img src="../../img/garis1.gif" width="400" height="1"></p>
                      </div></td>
                  </tr>
