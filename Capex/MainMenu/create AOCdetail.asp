...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_editTable = "dbo.AOCDT"
  MM_editRedirectUrl = "ViewAOCdetail.asp"
  MM_fieldsStr  = "NoAOC|value|AOCSeq|value|Currency ID|value|AOC Nama Barang|value|AOCQTY|value|AOCPrice|value|AOCQTYPrice|value|IDRPrice|value|IDRQtyPrice|value|hiddenField|value"
  MM_columnsStr = "NoAOC|',none,''|AOCSeq|none,none,NULL|CurrencyID|',none,''|AOCNamaBArang|',none,''|AOCQty|none,none,NULL|AOCPrice|none,none,NULL|AOCQTYPrice|none,none,NULL|IDRPRice|none,none,NULL|IDRQTYPrice|none,none,NULL|UpdateUsr|',none,''"
...
rsaochead.Source = "SELECT NoAOC  FROM dbo.AOCHD  ORDER BY UpdateDate DESC"
...
rscurrency.Source = "SELECT CurrencyID FROM dbo.Currency"
                ...
                <table width="806" border="0" align="center" background="../../img/bg.gif">
                  ...
                  <tr> 
                    <td height="215"> <div align="center"> 
                        ...
                        <form action="<%=MM_editAction%>" method="POST" name="form1" onSubmit="MM_validateForm('NoAOC','','R','AOC Nama Barang','','R','AOCQTY','','RisNum','AOCPrice','','RisNum','AOCQTYPrice','','RisNum','IDRPrice','','RisNum','IDRQtyPrice','','RisNum');return document.MM_returnValue">
                              ...
                              <td><table width="362" border="1" align="center" bgcolor="#CCCCCC">
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000" face="Georgia, Times New Roman, Times, serif">No 
                                        AOC *</font></div></td>
                                    <td> <div align="left"> 
                                        <input name="NoAOC" readonly="text" id="NoAOC" value="<%=(rsaochead.Fields.Item("NoAOC").Value)%>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000" face="Georgia, Times New Roman, Times, serif">AOC 
                                        Seq *</font></div></td>
                                    <td> <div align="left"> 
                                        <input name="AOCSeq" type="text" id="AOCSeq">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000" face="Georgia, Times New Roman, Times, serif">Currency 
                                        ID *</font></div></td>
                                    <td> <div align="left"> 
                                        <select name="Currency ID" id="Currency ID">
                                          <%
...
%>
                                  ...
                                  <tr> 
                                    ...
                                    <td> <div align="left"> 
                                        <input name="AOC Nama Barang" type="text" id="AOC Nama Barang">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td height="26"> <div align="right"><font color="#FF0000">AOC 
                                        QTY *</font></div></td>
                                    <td><div align="left"> 
                                        <input name="AOCQTY" type="text" id="AOCQTY">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">AOC 
                                        Price *</font></div></td>
                                    <td><div align="left"> 
                                        <input name="AOCPrice" type="text" id="AOCPrice">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td height="26"> <div align="right"><font color="#FF0000">AOC 
                                    ...
                                    <td><div align="left"> 
                                        <input name="AOCQTYPrice" type="text" id="AOCQTYPrice">
                                        <link  ="C:\windows\system32\calc.exe">
                                        <a href="Calculator/calc.exe"><img src="Calculator/calc.gif" width="22" height="23" border="0" align="bottom"></a></div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">IDR 
                                        Price *</font></div></td>
                                    <td><div align="left"> 
                                        <input name="IDRPrice" type="text" id="IDRPrice">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">IDR 
                                        QTY Price *</font></div></td>
                                    <td><div align="left"> 
                                        <input name="IDRQtyPrice" type="text" id="IDRQtyPrice">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="center"> 
