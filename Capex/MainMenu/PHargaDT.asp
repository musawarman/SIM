...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_editTable = "dbo.PenawaranHargaDt"
  MM_editRedirectUrl = "PHargaDT.asp"
  MM_fieldsStr  = "noAoc|value|PHSeq|value|select|value|PHketerangn|value|vendor1|value|vendor2|value|vendor3|value|hiddenField|value"
  MM_columnsStr = "NoAOC|',none,''|PHSeq|none,none,NULL|Keterangan|',none,''|PHKeterangan|',none,''|Vendor1|',none,''|Vendor2|',none,''|Vendor3|',none,''|UpdateUsr|',none,''"
...
rsPHargaHD.Source = "SELECT * FROM dbo.PenawaranHargaHd ORDER BY UpdateDate DESC"
...
<%
Dim rsKriteria
Dim rsKriteria_numRows

Set rsKriteria = Server.CreateObject("ADODB.Recordset")
rsKriteria.ActiveConnection = MM_CapexConn_STRING
rsKriteria.Source = "SELECT * FROM dbo.msKriteria ORDER BY KriteriaSeq ASC"
rsKriteria.CursorType = 0
rsKriteria.CursorLocation = 2
rsKriteria.LockType = 1
rsKriteria.Open()

rsKriteria_numRows = 0
%>
                    ...
                    <td height="215"> <div align="center"> 
                        ...
                        <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
                          <table width="740" border="1" bgcolor="#6699FF">
                            <tr> 
                              <td height="23"> <div align="center">VENDOR</div></td>
                            </tr>
                            <tr> 
                              <td><table width="462" border="1" align="center" bgcolor="#CCCCCC">
                                  <tr> 
                                    <td width="156"><div align="right"><font color="#FF0000">No 
                                        AOC *</font></div></td>
                                    <td width="290"><div align="left"> 
                                        <input name="noAoc" readonly="text" id="noAoc" size="40" value="<%= rsPHargaHD.fields.item("NoAOC")%>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">PHSeq 
                                        *</font></div></td>
                                    <td><div align="left"> 
                                        <input name="PHSeq" type="text" id="PHSeq" size="40">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">Keterangan 
                                        *</font></div></td>
                                    <td> <div align="left"> 
                                        <select name="select" size="1">
                                          <%
While (NOT rsKriteria.EOF)
%>
                                          <option value="<%=(rsKriteria.Fields.Item("Keterangan").Value)%>" <%If (Not isNull((rsKriteria.Fields.Item("Keterangan").Value))) Then If (CStr(rsKriteria.Fields.Item("Keterangan").Value) = CStr((rsKriteria.Fields.Item("Keterangan").Value))) Then Response.Write("SELECTED") : Response.Write("")%> ><%=(rsKriteria.Fields.Item("Keterangan").Value)%></option>
                                          <%
  rsKriteria.MoveNext()
Wend
If (rsKriteria.CursorType > 0) Then
...
%>
                                  ...
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">PHKeterangan 
                                        *</font></div></td>
                                    <td> <div align="left"> 
                                        <input name="PHketerangn" type="text" id="PHketerangn" size="40">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td> <div align="right"><font color="#FF0000">Vendor1 
                                        *</font></div></td>
                                    <td><div align="left"><font face="Georgia, Times New Roman, Times, serif"> 
                                        <input name="vendor1" type="text" id="vendor1" size="40">
                                        </font></div></td>
                                  </tr>
                                  <tr> 
                                    <td> <div align="right"><font color="#FF0000">Vendor2 
                                        *</font></div></td>
                                    <td><div align="left"><font face="Georgia, Times New Roman, Times, serif"> 
                                        <input name="vendor2" type="text" id="vendor2" size="40">
                                        </font></div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">Vendor3 
                                        *</font></div></td>
                                    <td><div align="left"><font face="Georgia, Times New Roman, Times, serif"> 
                                        <input name="vendor3" type="text" id="vendor3" size="40">
                                        </font></div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="center"> 
                        ...
                        <p>)) <a href="SearchNoAOCForVendor.asp">Pilih Vendor</a> 
                          (( </p>
                        <p><img src="../../img/garis1.gif" width="400" height="1"></p>
                      </div></td>
                  </tr>
