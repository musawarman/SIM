...
If (CStr(Request(MM_flag)) <> "") Then
  MM_dupKeyRedirect="MasterCurrencyCek.asp"
  MM_rsKeyConnection=MM_CapexConn_STRING
  MM_dupKeyUsernameValue = CStr(Request.Form("CurrencyID"))
  MM_dupKeySQL="SELECT CurrencyID FROM dbo.Currency WHERE CurrencyID='" & MM_dupKeyUsernameValue & "'"
...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_editRedirectUrl = "MasterCurrency.asp"
  MM_fieldsStr  = "CurrencyID|value|CurrencyName|value|hiddenField|value"
  MM_columnsStr = "CurrencyID|',none,''|CurrencyName|',none,''|UpdateUsr|',none,''"
...
<div align="center"> 
  <table width="600" border="0">
    ...
    <tr> 
      <td colspan="2"><h3 align="center"><font color="#6699FF">.:: Master Currency 
          ::. </font></h3></td>
    </tr>
    <tr> 
      <td width="484" height="39"> <div align="left"> 
  ...
  <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
    <table width="579" height="136" border="1" align="center" cellspacing="0" bordercolor="#999999">
      <tr bgcolor="#000099"> 
        <td colspan="2"> <div align="center"> <font color="#FFFFFF" size="3" face="Comic Sans MS">Currency 
            Information</font></div></td>
      </tr>
      <tr bgcolor="#CCCCCC"> 
        <td width="166"> <div align="right" class="style5">Currency ID : </div></td>
        <td width="403"> <div align="left"> 
            <input name="CurrencyID" type="text" id="CurrencyID">
            *<br>
            <span class="style5">Warning</span><font color="#0000FF"> : Budget 
            ID is already exist, please change another else </font> </div>
          <div align="center"></div></td>
      </tr>
      <tr bgcolor="#CCCCCC"> 
        <td> <div align="right" class="style5">Currency Name : </div></td>
        <td> <div align="left"> 
      ...
      <tr bgcolor="#CCCCCC"> 
        <td height="28"> <div align="center"> 
            <input name="Submit" type="submit" onClick="MM_validateForm('CurrencyID','','R','CurrencyName','','R');return document.MM_returnValue" onMouseOver="MM_displayStatusMsg('rz : master currency -&gt; submit&lt;add new record&gt;');return document.MM_returnValue" value="Submit">
            <input name="Submit2" type="reset" onMouseOver="MM_displayStatusMsg('rz : master currency -&gt; reset');return document.MM_returnValue" value="Reset">
          </div></td>
        <td> <div align="right"> 
      ...
      <tr bgcolor="#CCCCCC"> 
        <td height="16" colspan="2"> <div align="left"><font color="#0000FF">*) 
            required <br>
            </font></div></td>
      </tr>
    </table>
    [ <a href="ListCurrency.asp" target="_parent">List Currency</a> ] <br>
