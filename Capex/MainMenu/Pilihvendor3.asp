...
If (Request.QueryString("PHVendorName3") <> "") Then 
  rsPHarga__MMColParam = Request.QueryString("PHVendorName3")
End If
%>
<%
...
rsPHarga.Source = "SELECT PHVendorName1, PHVendorName2, PHVendorName3, PHReason,NoAOC  FROM dbo.PenawaranHargaHd  WHERE PHVendorName3 = '" + Replace(rsPHarga__MMColParam, "'", "''") + "'  and NoAOC ='" + Replace(rsPHarga__MMColParams, "'", "''") + "'"
                          ...
                          <table width="740" border="1" bgcolor="#6699FF">
                            ...
                            <tr> 
                              <td><table width="590" border="1" align="center" bordercolor="#006600" bgcolor="#CCCCCC">
                                  ...
                                  <tr> 
                                    <td width="239"><div align="right"><font color="#FF0000">Vendor 
                                        Yang Dipilih *</font></div></td>
                                    <td width="335"><div align="left"> 
                                        <input readonly="text" name="textfield" value="<%= rsPHarga.fields.item("PHVendorName3")%>">
                                      </div></td>
                                  </tr>
                                  <tr> 
                                    <td><div align="right"><font color="#FF0000">Alasan 
                                        *</font></div></td>
                                    <td><div align="left"> 
