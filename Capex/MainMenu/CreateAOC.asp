...
If MM_valUsername <> "" Then
  ...
  MM_redirectLoginSuccess="create AOC.asp"
  MM_redirectLoginFailed="confirmStatusapprAOC.asp"
  MM_flag="ADODB.Recordset"
  set MM_rsUser = Server.CreateObject(MM_flag)
  MM_rsUser.ActiveConnection = MM_CapexConn_STRING
  MM_rsUser.Source = "SELECT NoCapex, NoCapex"
  If MM_fldUserAuthorization <> "" Then MM_rsUser.Source = MM_rsUser.Source & "," & MM_fldUserAuthorization
  MM_rsUser.Source = MM_rsUser.Source & " FROM dbo.CapexHD WHERE NoCapex='" & Replace(MM_valUsername,"'","''") &"' AND NoCapex='" & Replace(Request.Form("nocapex"),"'","''") & "'"
  ...
  If Not MM_rsUser.EOF Or Not MM_rsUser.BOF Then 
	...
	Session("Updatenocapex") = session("MM_Username")
...
<!--
function confirm() {
	var nocapex = document.form1.nocapex.value ;
	
	if (nocapex == ""){
	alert("No Capex Tidak boleh kosong")
	document.form1.nocapex.focus()
	return false
	}
}
                ...
                <table width="806" border="0" align="center" background="../../img/bg.gif">
                  ...
                  <tr> 
                    <td height="215"> <div align="center"> 
                        ...
                        <form ACTION="<%=MM_LoginAction%>" method="POST" name="form1" onSubmit="return dbo.p_checknocapex()">
                          <table width="397" border="1" align="center" bordercolor="#CCCCCC" bgcolor="#6699FF">
                            <tr bgcolor="#6699FF"> 
                              <td width="145" height="28"> <div align="center"><font color="#FFFFFF">No 
                                  Capex</font></div></td>
