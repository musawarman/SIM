...
Dim UpdateAOCAppr__NoAOC
UpdateAOCAppr__NoAOC = ""
if(Request("NoAOC") <> "") then UpdateAOCAppr__NoAOC = Request("NoAOC")

Dim UpdateAOCAppr__userID
UpdateAOCAppr__userID = ""
if(Session("UpdateUsr") <> "") then UpdateAOCAppr__userID = Session("UpdateUsr")
...
set UpdateAOCAppr = Server.CreateObject("ADODB.Command")
UpdateAOCAppr.ActiveConnection = MM_CapexConn_STRING
UpdateAOCAppr.CommandText = "dbo.P_UpdateAOCApproval"
UpdateAOCAppr.CommandType = 4
UpdateAOCAppr.CommandTimeout = 0
UpdateAOCAppr.Prepared = true
UpdateAOCAppr.Parameters.Append UpdateAOCAppr.CreateParameter("@RETURN_VALUE", 3, 4)
UpdateAOCAppr.Parameters.Append UpdateAOCAppr.CreateParameter("@NoAOC", 200, 1,20,UpdateAOCAppr__NoAOC)
UpdateAOCAppr.Parameters.Append UpdateAOCAppr.CreateParameter("@userID", 200, 1,20,UpdateAOCAppr__userID)
UpdateAOCAppr.Execute()
...
If MM_valUsername <> "" Then
  ...
  MM_redirectLoginSuccess="ConfirmapprovaAOCl.asp"
  MM_redirectLoginFailed="InfoAOCappr.asp"
  MM_flag="ADODB.Recordset"
  set MM_rsUser = Server.CreateObject(MM_flag)
  MM_rsUser.ActiveConnection = MM_CapexConn_STRING
  MM_rsUser.Source = "SELECT NoAOC, NoAOC"
  If MM_fldUserAuthorization <> "" Then MM_rsUser.Source = MM_rsUser.Source & "," & MM_fldUserAuthorization
  MM_rsUser.Source = MM_rsUser.Source & " FROM dbo.AOCAppr WHERE NoAOC='" & Replace(MM_valUsername,"'","''") &"' AND NoAOC='" & Replace(Request.Form("NoAOC"),"'","''") & "'"
  ...
  If Not MM_rsUser.EOF Or Not MM_rsUser.BOF Then 
	...
	Session("UpdatenoAoc") = Session("MM_Username")
                  ...
                  <table width="740" border="1" bgcolor="#6699FF">
                    ...
                    <tr> 
                      <td><table width="362" border="1" align="center" bgcolor="#CCCCCC">
                          <tr> 
                            <td><div align="right"><font color="#FF0000">No AOC 
                                *</font></div></td>
                            <td><div align="left"> 
                                <input name="NoAOC" readonly="text" id="NoAOC2" value="<%=(rsAOCHD.Fields.Item("NoAOC").Value)%>">
                              </div></td>
                          </tr>
                          <tr> 
                            <td><div align="right"><font color="#FF0000">User 
                                ID *</font></div></td>
                            <td><div align="left"> 
                          ...
                          <tr> 
                            <td><div align="right"><font color="#FF0000">JabatanID 
                                *</font></div></td>
                            <td><div align="left"> 
                                <input name="NoAOC2" readonly="text" id="NoAOC2" value="<%= Jabatan.Parameters.Item("@JabatanID").Value %>">
                              </div></td>
                          </tr>
                          <tr> 
                            <td><div align="right"><font color="#FF0000">Tanggal 
                                Approval AOC *</font></div></td>
                            <td><div align="left"> 
                                <input name="Tanggal" readonly="text" id="Tanggal2" value="<%=date%>" >
                              </div></td>
                          </tr>
                          <tr> 
                            <td><div align="center"> 
                          ...
                          <tr> 
                            <td colspan="2"><div align="left">*) harus diisi</div></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table>
