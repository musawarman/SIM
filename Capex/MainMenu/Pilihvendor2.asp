...
If (Request.QueryString("PHVendorName2") <> "") Then 
  rsPHarga__MMColParam = Request.QueryString("PHVendorName2")
End If
%>
<%
...
rsPHarga.Source = "SELECT PHVendorName1, PHVendorName2, PHVendorName3, PHReason,NoAOC  FROM dbo.PenawaranHargaHd  WHERE PHVendorName2 = '" + Replace(rsPHarga__MMColParam, "'", "''") + "' and NoAOC =  '" + Replace(rsPHarga__MMColParams, "'", "''") + "'"
                          ...
                          <table width="740" border="1" bgcolor="#6699FF">
                            ...
                            <tr> 
                              <td><table width="590" border="1" align="center" bordercolor="#006600" bgcolor="#CCCCCC">
                                  ...
                                  <tr> 
                                    <td width="175"><div align="right"><font color="#0000FF">Vendor 
                                        Yang Dipilih *</font></div></td>
                                    <td width="399"><div align="left"> 
                                        <input readonly="text" name="textfield" value="<%= rsPHarga.fields.item("PHVendorName2")%>">
                                      </div></td>
                                  </tr>
                                  <tr> 
