...
<body background="star.gif" onLoad="MM_preloadImages('../Image/homee.gif','../Image/aboutus.gif','../Image/contact.gif','../Image/Promotion.gif','../Image/Solutions.gif')">
<table width="740" height="572" border="1" bordercolor="#0000FF">
  ...
  <tr> 
    ...
    <td width="72" bordercolor="#0000FF"> <div align="center"><font color="#FF0000">Created 
        By</font></div></td>
    <td width="600"> <div align="center">:: Riza Muhammad Nurman ::</div></td>
    <td width="1">&nbsp;</td>
  </tr>
  <tr> 
    <td height="23">&nbsp;</td>
    ...
    <td rowspan="9"> <table width="600" border="1" align="center" cellspacing="0" bgcolor="#003333">
        ...
        <tr> 
          <td width="225" rowspan="8" bgcolor="#990066"><img src="../Image/riza.gif" width="225" height="150"></td>
          <td width="180" bgcolor="#6699FF"><div align="right"><font color="#FFFF00">Nama 
              Lengkap </font></div></td>
          <td width="331" bgcolor="#663366"><font color="#FFFFFF">Riza Muhammad 
            Nurman</font></td>
        </tr>
        <tr> 
          <td bgcolor="#6699FF"><div align="right"><font color="#FFFF00">Panggilan 
              </font></div></td>
          <td bgcolor="#663366"><font color="#FFFFFF">Riza</font></td>
        </tr>
        <tr> 
          <td bgcolor="#6699FF"><div align="right"><font color="#FFFF00">Tempat,Tanggal 
              Lahir</font></div></td>
          <td bgcolor="#663366"><font color="#FFFFFF">Bogor, 13 April 1984 </font></td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td bgcolor="#663366"><p><font color="#FFFFFF">(0251) 341420</font></p>
            <p><font color="#FFFFFF">085218192694</font></p></td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td bgcolor="#663366"><p><font color="#FFFFFF">rhyz_fantastic@plasa.com 
              </font></p>
            <p><font color="#FFFFFF">rhy_zone@yahoo.com </font></p></td>
        </tr>
        <tr bgcolor="#CCCCCC"> 
          <td colspan="3">&nbsp;</td>
        </tr>
