...
If (CStr(Request("MM_insert")) = "form1") Then
  ...
  MM_editRedirectUrl = "confirm_order_doc.asp"
  MM_fieldsStr  = "Kategori|value|NamaProd|value|Kuantitas|value|Satuan|value|Status|value|Tanggal Pesan|value|p_username2|value|hiddenField|value"
  MM_columnsStr = "Category|',none,''|Nama_Produk|',none,''|Kuantitas|',none,''|SatuanBerat|',none,''|Status|',none,''|Tanggal_Pesan|',none,NULL|UserID|',none,''|UpdateUser|',none,''"
...
%>
<%
Dim rsNamaPrd__MMColParam
rsNamaPrd__MMColParam = "1"
If (Request.QueryString("ID_PrdName") <> "") Then 
  rsNamaPrd__MMColParam = Request.QueryString("ID_PrdName")
End If
%>
<%
Dim rsNamaPrd
Dim rsNamaPrd_numRows

Set rsNamaPrd = Server.CreateObject("ADODB.Recordset")
rsNamaPrd.ActiveConnection = MM_simConn_STRING
rsNamaPrd.Source = "SELECT * FROM dbo.tb_PrdName WHERE ID_PrdName = " + Replace(rsNamaPrd__MMColParam, "'", "''") + ""
rsNamaPrd.CursorType = 0
rsNamaPrd.CursorLocation = 2
rsNamaPrd.LockType = 1
rsNamaPrd.Open()
...
<body bgcolor="#FFFFFF" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('img/depan_on.gif','img/ID_on.gif','img/laporan_on.gif')">
<table width="800" border="1" align="center" bordercolor="#006600">
  <tr bordercolor="#006600" bgcolor="#FFFFFF"> 
    <td colspan="2"> 
...
<table width="800" border="1" align="center" background="business/img/bg.gif">
  <tr>
    <td height="470">
<div align="center"> 
        <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1" onSubmit="MM_validateForm('Kuantitas','','RisNum');return document.MM_returnValue">
          <table width="424" border="1">
            <tr> 
              <td width="142"><img src="Icon/account.gif" width="29" height="25"><font size="2">Pemesanan 
                </font> </td>
              <td width="266">&nbsp;</td>
            </tr>
            <tr> 
              <td> <div align="right">Kategori * :</div></td>
              <td> <input name="Kategori" readonly="text" id="Kategori" value="<%= response.write ("DOC")%>"></td>
            </tr>
            <tr> 
              <td> <div align="right">Nama Produk * :</div></td>
              <td><input name="NamaProd" readonly="text" id="NamaProd" value="<%=(rsNamaPrd.Fields.Item("Nama_Produk").Value)%>"> </td>
            </tr>
            <tr> 
              <td> <div align="right">Kuantitas * :</div></td>
              <td> <input name="Kuantitas" type="text" id="Kuantitas"></td>
            </tr>
            <tr> 
              <td> <div align="right">Satuan * :</div></td>
              <td> <input name="Satuan" readonly="text" id="Satuan" value="<%= response.write ("EKOR")%>"></td>
            </tr>
            <tr> 
              <td> <div align="right">Status * :</div></td>
              <td> <input name="Status" readonly="text" id="Status" value="<%= response.write ("PESAN")%>"></td>
            </tr>
            <tr> 
              <td> <div align="right">Tanggal Pesan * :</div></td>
              <td> <input name="Tanggal Pesan" readonly="text" id="Tanggal Pesan" value="<%= date %>"> 
              </td>
            </tr>
            <tr> 
              <td colspan="2"> <div align="center"> 
                  <INPUT                        name=p_username2 
