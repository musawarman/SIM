...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_fieldsStr = "textfield|value|textarea|value|textfield2|value|select|value|hiddenField|value";
  var MM_columnsStr = "JobTitle|',none,''|Qualification|',none,''|Deadline|',none,NULL|Lang|',none,''|updateby|',none,''";
          ...
          <TR vAlign=top> 
            <TD class=tdverylight> <form action="<%=MM_editAction%>" method="POST" name="form1">
                <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                  <TBODY>
                    <TR> 
                      <TD align=right class=tddark width=125>Job Title *</TD>
                      <TD class=tddark width=5>:</TD>
                      <TD class=tdlight vAlign=top> <input type="text" name="textfield"></TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Qualification * 
                      </TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight vAlign=top><textarea name="textarea" cols="40" rows="10"></textarea> 
                      </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Deadline * </TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD valign="top" class=tdlight><input type="text" name="textfield2"> 
                      </TD>
                    </TR>
                    <TR> 
