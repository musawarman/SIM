...
rsCareers.Source = "SELECT ID, Del, JobTitle, Qualification, Deadline, updateby, tgl  FROM dbo.Careers";
  ...
  <TBODY>
    <TR> 
      ...
      <TABLE cellSpacing=0 cellPadding=2 width="100%" border=0><TBODY>
          ...
          <TD class=tdtitle>Browse Careers</TD>
          </TR>
          <TR vAlign=top> 
            <TD class=tdverylight> <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
              ...
              <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
                <FORM action=Add_careers.asp method=post>
                  <TBODY>
                    <TR> 
                  ...
                  <% while ((Repeat1__numRows-- != 0) && (!rsCareers.EOF)) { %>
                  <TR class=trlight> 
                    <TD vAlign=top><div align="center"><%=response.write(Repeat1__index + 1) %></div></TD>
                    <TD vAlign=top align=middle><A HREF="Del_careers.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsCareers.Fields.Item("ID").Value %>"><%=(rsCareers.Fields.Item("Del").Value)%></A> </TD>
                    <TD vAlign=top align=middle><A HREF="M_careers.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsCareers.Fields.Item("ID").Value %>"><IMG 
                  height=15 
                  src="modify.gif" 
                  width=21 border=0></A> </TD>
                    <TD vAlign=top><%=(rsCareers.Fields.Item("JobTitle").Value)%></TD>
                    <TD vAlign=top><%=(rsCareers.Fields.Item("Qualification").Value)%></TD>
                    <TD vAlign=top><%=(rsCareers.Fields.Item("updateby").Value)%></TD>
                    <TD vAlign=top><%= DoDateTime((rsCareers.Fields.Item("tgl").Value), 1, 2057) %></TD>
                  </TR>
                  <%
  Repeat1__index++;
  rsCareers.MoveNext();
