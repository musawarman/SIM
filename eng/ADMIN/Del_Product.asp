...
if (String(Request("MM_delete")) == "form1" &&
  ...
  var MM_editTable = "dbo.Product";
  var MM_editColumn = "Prodid";
  var MM_recordId = "" + Request.Form("MM_recordId") + "";
  var MM_editRedirectUrl = "br_product.asp";
    ...
    <TR> 
      <TD width=1000 valign="top" class=tdtitle> <!-- InstanceBeginEditable name="EditRegion3" --> 
        <table cellspacing=0 cellpadding=2 width="100%" border=0>
          <tbody>
            <tr> 
              <td class=tdtitle>Delete Record Product</td>
            </tr>
            <tr valign=top> 
              <td class=tdlight> <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
                  ...
                  <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                    <TBODY>
                      <TR valign="top"> 
                        ...
                        <TD class=tdlight><%=(rsProduct.Fields.Item("Prodid").Value)%> </TD>
                      </TR>
                      <TR valign="top"> 
                        <TD align=right class=tddark>Title * </TD>
                        <TD class=tddark>:</TD>
                        <TD class=tdlight><%=(rsProduct.Fields.Item("name").Value)%> </TD>
                      </TR>
                      <TR valign="top"> 
                        <TD align=right class=tddark>Lead *</TD>
                        <TD class=tddark>:</TD>
                        <TD class=tdlight><%=(rsProduct.Fields.Item("lead").Value)%></TD>
                      </TR>
                      <TR valign="top"> 
                        <TD align=right class=tddark>Content *</TD>
                        <TD class=tddark>:</TD>
                        <TD class=tdlight><%=(rsProduct.Fields.Item("detail").Value)%></TD>
                      </TR>
                      <TR valign="top"> 
                        <TD align=right class=tddark>Update By *</TD>
                        <TD class=tddark>:</TD>
                        <TD class=tdlight><%=(rsProduct.Fields.Item("updateby").Value)%></TD>
                      </TR>
                      <TR valign="top"> 
                        <TD width=130 align=right class=tddark>Date *</TD>
                        <TD width=5 class=tddark>:</TD>
                        <TD class=tdlight><%=(rsProduct.Fields.Item("tgl").Value)%> </TD>
                      </TR>
                      <TR> 
                  ...
                  <input type="hidden" name="MM_recordId" value="<%= rsProduct.Fields.Item("Prodid").Value %>">
                </form>
                <TABLE cellSpacing=0 cellPadding=2 width="100%" border=0>
