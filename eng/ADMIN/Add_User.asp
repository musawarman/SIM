...
if (String(Request("MM_insert")) == "form1") {
  ...
  var MM_fieldsStr = "textfield|value|textfield2|value|textfield3|value|select|value|hiddenField|value|hiddenField2|value";
  var MM_columnsStr = "Name|',none,''|Login|',none,''|Password|',none,''|levelID|none,none,NULL|updateby|',none,''|DeptID|',none,''";
...
rsMember.Source = "SELECT * FROM dbo.members";
    ...
    <TR> 
      <TD width=1000 valign="top" class=tdtitle> <!-- InstanceBeginEditable name="EditRegion3" --> 
        <TABLE border=0 cellPadding=2 cellSpacing=0 width="100%"><TBODY>
          <TR> 
            <TD class=tdtitle>Add Case Report</TD>
          </TR>
          <TR vAlign=top> 
            <TD class=tdverylight> <form action="<%=MM_editAction%>" method="POST" name="form1">
                <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                  <TBODY>
                    <TR> 
                      <TD align=right class=tddark width=125>Name *</TD>
                      <TD class=tddark width=5>:</TD>
                      <TD class=tdlight vAlign=top><input type="text" name="textfield"> 
                      </TD>
                    </TR>
                    <TR> 
                    ...
                    <TR> 
                      ...
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight><input type="password" name="textfield3"> 
                      </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Level *&nbsp;</TD>
                      <TD class=tddark vAlign=top>:</TD>
                    ...
                    <TR> 
                      ...
                      <TD class=tdlight> 
                        ...
                        <input name="hiddenField2" type="hidden" value="ADM">
                      </TD>
                    </TR>
                    <TR> 
