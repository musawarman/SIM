...
var MM_authorizedUsers="5,7,6,4";
var MM_authFailedURL="../../ADMIN/Failed.asp";
...
rsNews.Source = "SELECT ID, Del,Title, Clip, updateby, tgl  FROM dbo.News where lang='Inggris'  ORDER BY tgl DESC";
rsNews.CursorType = 0;
  ...
  <TBODY>
    ...
    <TD width=1000 valign="top" class=tdtitle> <!-- InstanceBeginEditable name="EditRegion3" --> 
      <TABLE cellSpacing=0 cellPadding=2 width="100%" border=0><TBODY>
          ...
          <TD class=tdtitle>Browse News (English Version)</TD>
          </TR>
          <TR vAlign=top> 
            <TD class=tdverylight> <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
              ...
              <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
                <FORM action=Add_News.asp method=post>
                  <TBODY>
                    <TR> 
                  ...
                  <TR class=trlight> 
                    ...
                    <TD vAlign=top align=middle><A HREF="Del_News.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsNews.Fields.Item("ID").Value %>"><%=(rsNews.Fields.Item("Del").Value)%></A> </TD>
                    <TD vAlign=top align=middle><A HREF="M_News.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsNews.Fields.Item("ID").Value %>"><IMG 
                  height=15 
                  src="modify.gif" 
                  width=21 border=0></A> </TD>
                    <TD vAlign=top><%=(rsNews.Fields.Item("Title").Value)%></TD>
                    <TD vAlign=top><%=(rsNews.Fields.Item("clip").Value)%></TD>
                    <TD vAlign=top><%=(rsNews.Fields.Item("updateby").Value)%></TD>
                    <TD vAlign=top><%= DoDateTime((rsNews.Fields.Item("tgl").Value), 1, 2057) %></TD>
                  </TR>
                  <%
  Repeat1__index++;
  rsNews.MoveNext();
