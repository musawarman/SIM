...
<table cellspacing=0 cellpadding=2 width="100%" border=0>
          <tbody>
            <tr> 
              <td class=tdtitle>Delete Record Visi &amp; Mision</td>
            </tr>
            <tr valign=top> 
              <td class=tdlight> <form ACTION="<%=MM_editAction%>" name="form1" method="POST">
                  ...
                  <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                    <TBODY>
                      <TR> 
                        <TD width=130 align=right valign="top" class=tddark><div align="right">Sejarah 
                            ID *</div></TD>
                        <TD width=9 valign="top" class=tddark>:</TD>
                        <TD width="426" valign="top" class=tdlight><%=(rsVisi.Fields.Item("ID").Value)%> </TD>
                      </TR>
                      <TR valign="top"> 
                        <TD height="23" align=right class=tddark>Header * </TD>
                        <TD class=tddark>:</TD>
                        <TD class=tdlight><%=(rsVisi.Fields.Item("Head").Value)%> </TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Content *</TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsVisi.Fields.Item("Content").Value)%></TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Image *</TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsVisi.Fields.Item("image").Value)%></TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Update By*</TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsVisi.Fields.Item("updateby").Value)%></TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Tanggal * </TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsVisi.Fields.Item("tgl").Value)%></TD>
                      </TR>
                      <TR> 
