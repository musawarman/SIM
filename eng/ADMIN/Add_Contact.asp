...
rsContact.Source = "SELECT * FROM dbo.Contact";
                ...
                <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                  ...
                  name=p_title class=btn_text size=40> </TD>
                    ...
                    <TR> 
                      ...
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight vAlign=top> <INPUT 
                  name=p_title2 class=btn_text size=40> </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Phone</TD>
                      <TD class=tddark vAlign=top>&nbsp;</TD>
                      <TD class=tdlight vAlign=top><input 
                  name=p_title22 class=btn_text size=40></TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Fax&nbsp;</TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight vAlign=top><INPUT 
                  name=p_title23 class=btn_text size=40> <input name="hiddenField" type="hidden" value="<%= Session("updateby") %>"> 
                      </TD>
                    </TR>
                    <TR> 
