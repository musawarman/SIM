                  ...
                  <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                    <TBODY>
                      <TR> 
                        ...
                        <TD width="426" valign="top" class=tdlight><%=(rsSejarah.Fields.Item("ID").Value)%> </TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Header * </TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsSejarah.Fields.Item("Head").Value)%> </TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Content *</TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsSejarah.Fields.Item("Content").Value)%></TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Image *</TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsSejarah.Fields.Item("image").Value)%></TD>
                      </TR>
                      <TR> 
                        <TD align=right valign="top" class=tddark>Update By*</TD>
                        <TD valign="top" class=tddark>:</TD>
                        <TD valign="top" class=tdlight><%=(rsSejarah.Fields.Item("updateby").Value)%></TD>
                      </TR>
                      <TR valign="top"> 
                        <TD align=right class=tddark>Tanggal * </TD>
                        <TD class=tddark>:</TD>
                        <TD class=tdlight><%=(rsSejarah.Fields.Item("tgl").Value)%></TD>
                      </TR>
                      <TR> 
