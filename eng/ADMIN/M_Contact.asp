...
if (String(Request("MM_update")) == "form1" &&
  ...
  var MM_fieldsStr = "p_title|value|p_lead|value|p_content|value|p_title2|value|p_title22|value|p_title23|value|hiddenField|value";
  var MM_columnsStr = "Company|',none,''|Address1|',none,''|Address2|',none,''|City|',none,''|Phone|',none,''|Fax|',none,''|UpdateBy|',none,''";
    ...
    <TR> 
      <TD width=1000 valign="top" class=tdtitle> <!-- InstanceBeginEditable name="EditRegion3" -->
        <TABLE border=0 cellPadding=2 cellSpacing=0 width="100%"><TBODY>
          <TR> 
            <TD class=tdtitle>Modify Contact</TD>
          </TR>
          <TR vAlign=top> 
            <TD class=tdverylight> <form action="<%=MM_editAction%>" method="POST" name="form1">
                <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                  ...
                  name=p_title class=btn_text value="<%=(rsContact.Fields.Item("Company").Value)%>" size=40> 
                      </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Address 1* </TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight vAlign=top><TEXTAREA class=btn_textarea cols=34 name=p_lead rows=5><%=(rsContact.Fields.Item("Address1").Value)%></TEXTAREA> 
                      </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Address 2* </TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight><TEXTAREA class=btn_textarea cols=34 name=p_content rows=10><%=(rsContact.Fields.Item("Address2").Value)%></TEXTAREA> 
                      </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>City&nbsp;</TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight vAlign=top> <INPUT 
                  name=p_title2 class=btn_text value="<%=(rsContact.Fields.Item("City").Value)%>" size=40> 
                      </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Phone</TD>
                      <TD class=tddark vAlign=top>&nbsp;</TD>
                      <TD class=tdlight vAlign=top><input 
                  name=p_title22 class=btn_text value="<%=(rsContact.Fields.Item("Phone").Value)%>" size=40></TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Fax&nbsp;</TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight vAlign=top><INPUT 
                  name=p_title23 class=btn_text value="<%=(rsContact.Fields.Item("Fax").Value)%>" size=40> 
                        <input name="hiddenField" type="hidden" value="<%= Session("updateby") %>"> 
                      </TD>
                    </TR>
                    <TR> 
