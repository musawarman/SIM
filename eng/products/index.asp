...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../products/index.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif">&nbsp;&nbsp;&nbsp;&nbsp;Breeding 
      ...
      system. <br> <br> &nbsp;&nbsp;&nbsp; Sierad Produce operates twelve breeding 
      farms and the majority are located in West Java. The farms produce a combined 
      total of more than 120 million day-old chicks per annum, catering to Sierad 
      Produce's own businesses as well as for the open market, both domestic and 
      export. </td>
