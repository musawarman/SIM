...
rsProduct.Source = "SELECT prodid,thumb,name,lead,detail  FROM dbo.product  WHERE groupid ='Biotek' and lang='Inggris'  ORDER BY prodid desc";
...
rsProduct_numRows += Repeat1__numRows;
%>
<%
var Repeat2__numRows = 2;
...
<body background="../business/img/bg.gif" leftmargin="0" topmargin="0" onLoad="MM_preloadImages('img/top_mn_on_01.gif','img/top_mn_on_02.gif','img/top_mn_on_03.gif','img/top_mn_on_04.gif','img/top_mn_on_06.gif','img/bg_mid_on__13.jpg','img/bg_mid_on__14.jpg','../business/img/mn_on_1.jpg','../business/img/mn_on_2.jpg','../business/img/mn_on_3.jpg','../business/img/mn_on_4.jpg','../business/img/mn_on_5.jpg','../business/img/mn_on_6.jpg','../business/img/mn_on_7.jpg','../business/img/mn_on_8.jpg','img/top_mn_on_05.gif')">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="70"><a href="feed.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','img/top_mn_on_01.gif',1)"><img src="img/top_mn-01.gif" alt="Feed" name="Image8" width="70" height="25" border="0"></a></td>
    ...
    <td width="110"><a href="equipment.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','img/top_mn_on_03.gif',1)"><img src="img/top_mn-03.gif" alt="Equipment" name="Image10" width="110" height="25" border="0"></a></td>
    <td width="170"><a href="animal.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image11','','img/top_mn_on_04.gif',1)"><img src="img/top_mn-04.gif" alt="Animal Pharmaceutical" name="Image11" width="170" height="25" border="0"></a></td>
    <td width="150"><a href="dressed.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image50','','img/top_mn_on_05.gif',1)"><img src="img/top_mn-05.gif" alt="Dressed Chicken" name="Image50" width="150" height="25" border="0"></a></td>
    <td width="90"><a href="delfarm.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image13','','img/top_mn_on_06.gif',1)"><img src="img/top_mn-06.gif" alt="Delfarm" name="Image13" width="90" height="25" border="0" id="Image13"></a></td>
    <td width="97"><img src="img/top_mn-07.gif" width="97" height="25"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../products/animal.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif"><img src="img/animal_ttl.gif"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"> <% while ((Repeat1__numRows-- != 0) && (!rsProduct.EOF)) { %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="26%"> <table width="124%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="left"><img src="<%=(rsProduct.Fields.Item("thumb").Value)%>"></div></td>
              </tr>
              <tr> 
          ...
          <td width="68%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><a href="animal_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "prodid=" + rsProduct.Fields.Item("prodid").Value %>"><strong><%=(rsProduct.Fields.Item("name").Value)%></strong></a></td>
              </tr>
              <tr> 
...
<div align="right"> 
        <% while ((Repeat2__numRows-- != 0) && (!rsNews.EOF)) { %>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
