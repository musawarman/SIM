...
rsProduct.Source = "SELECT prodid, image,name,lead,detail,tabel  FROM dbo.Product  WHERE Prodid = "+ rsProduct__MMColParam.replace(/'/g, "''") + " and groupid='RPA'  ORDER BY Prodid DESC";
