...
rsProduct.Source = "SELECT prodid,thumb,name,lead,detail  FROM dbo.product  WHERE groupid ='Delfarm' and lang='Inggris'  ORDER BY prodid desc";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../products/delfarm.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="68%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><a href="delfarm_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "prodid=" + rsProduct.Fields.Item("prodid").Value %>"><strong><%=(rsProduct.Fields.Item("name").Value)%></strong></a></td>
              </tr>
              <tr> 
