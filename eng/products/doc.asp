...
rsProduct.Source = "SELECT prodid, thumb,name,lead,detail  FROM dbo.product  WHERE groupid ='DOC' and lang='Inggris'  ORDER BY prodid desc";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../products/doc.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="25%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><img src="<%=(rsProduct.Fields.Item("thumb").Value)%>"></td>
              </tr>
              <tr> 
                <td>&nbsp;</td>
              </tr>
          ...
          <td width="72%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><strong><A HREF="doc_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "prodid=" + rsProduct.Fields.Item("prodid").Value %>"><%=(rsProduct.Fields.Item("name").Value)%></A></strong></td>
              </tr>
              <tr> 
