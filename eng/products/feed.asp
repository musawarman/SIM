...
rsProduct.Source = "SELECT prodid,thumb,name,lead,detail  FROM dbo.product  WHERE groupid ='Feed' and lang='Inggris'  ORDER BY prodid desc";
...
rsProduct_numRows += Repeat2__numRows;
%>
<% var MM_paramName = ""; %>
<%
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../products/feed.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"> <% while ((Repeat2__numRows-- != 0) && (!rsProduct.EOF)) { %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="68%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><a href="feed_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "prodid=" + rsProduct.Fields.Item("prodid").Value %>"><strong><%=(rsProduct.Fields.Item("name").Value)%></strong></a></td>
              </tr>
              <tr> 
