...
rsProduct.Source = "SELECT prodid, image,name,lead,detail,tabel  FROM dbo.product  WHERE groupid ='Feed' and Prodid = "+ rsProduct__MMColParam.replace(/'/g, "''") + "  ORDER BY Prodid DESC";
...
%> </td>
    <td width="9" valign="top" background="../business/img/bg_bottom.gif"> <div align="right"></div></td>
