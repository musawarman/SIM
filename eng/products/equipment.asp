...
rsProduct.Source = "SELECT prodid,thumb,name,lead,detail  FROM dbo.product  WHERE groupid ='Industri' and lang='Inggris'  ORDER BY prodid desc";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="150"><a href="dressed.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image12','','img/top_mn_on_05.gif',1)"><img src="img/top_mn-05.gif" alt="Dressed Chickent" name="Image12" width="150" height="25" border="0"></a></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../products/equipment.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif"><img src="img/equipment_ttl.gif"></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="68%" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><a href="equipment_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "prodid=" + rsProduct.Fields.Item("prodid").Value %>"><strong><%=(rsProduct.Fields.Item("name").Value)%></strong></a></td>
              </tr>
              <tr> 
