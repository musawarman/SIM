...
rsSejarah.Source = "SELECT *  FROM dbo.Sejarah where lang='Inggris'";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="125"><a href="index.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image8','','img/top_mn_on_06.gif',1)"><img src="img/top_mn-06.gif" alt="Vision Mision" name="Image8" width="125" height="25" border="0"></a></td>
    <td width="150"><a href="history.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image9','','img/top_mn_on_07.gif',1)"><img src="img/top_mn-07.gif" alt="History Background" name="Image9" width="150" height="25" border="0"></a></td>
    <td width="352"><img src="img/bg_mn_top_r1.gif" width="352" height="25"></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../corporate/history.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><div align="justify"><%=(rsSejarah.Fields.Item("Content").Value)%></div></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td width="252" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr> 
                  <td><A HREF="../news/News_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsSejarah.Fields.Item("ID").Value %>"><strong><%=(rsNews.Fields.Item("Title").Value)%></strong></A></td>
                </tr>
                <tr> 
          ...
          <tr> 
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><A HREF="../news/News_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsSejarah.Fields.Item("ID").Value %>"> 
