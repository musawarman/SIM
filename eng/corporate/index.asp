...
%>
<%
var rsVisi = Server.CreateObject("ADODB.Recordset");
rsVisi.ActiveConnection = MM_DBConn_STRING;
rsVisi.Source = "select * from dbo.visi_misi where lang='Inggris'";
rsVisi.CursorType = 0;
rsVisi.CursorLocation = 2;
rsVisi.LockType = 1;
rsVisi.Open();
var rsVisi_numRows = 0;
%>
<%
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../corporate/index.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif"><img src="img/misi_ttl.gif" height="21"></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><div align="justify"><%=(rsVisi.Fields.Item("Content").Value)%></div></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
        </tr>
