...
rsNews.Source = "SELECT id,image, title,content,thumbnail  FROM dbo.News  WHERE ID = "+ rsNews__MMColParam.replace(/'/g, "''") + " and lang='Inggris'";
rsNews.CursorType = 0;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../eng/news/index.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Versi Inggris" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"><p><img src="<%=(rsNews.Fields.Item("image").Value)%>" align="left"><strong><%=(rsNews.Fields.Item("title").Value)%></strong></p>
      <p>&nbsp;<%=(rsNews.Fields.Item("content").Value)%></p>
      <p>&nbsp;</p>
      <p align="center"> 
    ...
    <td width="325" valign="top" background="../business/img/bg_bottom.gif"> <div align="right"> 
