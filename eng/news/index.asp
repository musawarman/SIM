...
rsNews1.ActiveConnection = MM_DBConn_STRING;
rsNews1.Source = "SELECT ID, thumbnail, tgl, Title, Clip,  Lengkap  FROM dbo.News  WHERE lang='Inggris'  ORDER BY tgl DESC";
...
rsNews1_numRows += Repeat2__numRows;
%>
<% var MM_paramName = ""; %>
<%
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../news/index.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"> <% while ((Repeat1__numRows-- != 0) && (!rsNews.EOF)) { %>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="89%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr> 
                <td><strong><A HREF="News_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsNews.Fields.Item("ID").Value %>"><%=(rsNews.Fields.Item("title").Value)%></A></strong></td>
              </tr>
              <tr> 
                <td><%=(rsNews.Fields.Item("clip").Value)%></td>
              </tr>
              <tr> 
                <td><div align="right"><A HREF="News_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsNews.Fields.Item("ID").Value %>"><%=(rsNews.Fields.Item("lengkap").Value)%></A></div></td>
              </tr>
            </table></td>
        </tr>
        <tr> 
...
%> </td>
    ...
    <td width="325" valign="top" background="../business/img/bg_bottom.gif"> 
      <div align="right"> 
        <% while ((Repeat2__numRows-- != 0) && (!rsNews1.EOF)) { %>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="12" valign="top"> <div align="center"><strong>*</strong></div></td>
            <td width="237"><%= DoDateTime((rsNews1.Fields.Item("tgl").Value), 1, 2057) %> </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
            <td><div align="left"><A HREF="News_in.asp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "ID=" + rsNews1.Fields.Item("ID").Value %>"><strong><%=(rsNews1.Fields.Item("Title").Value)%></strong></A></div></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
