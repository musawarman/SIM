...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="200"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td><a href="corporate/index.html" onMouseOut="OutMenu('PopMenu2');MM_swapImgRestore()" onMouseOver="PopMenu('PopMenu2',event);MM_swapImage('Image8','','img/menu_on_1.jpg',1)"><img src="img/menu_1.jpg" alt="Corporate Overview" name="Image8" width="200" height="31" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="business/index.html" onMouseOut="OutMenu('PopMenu1');MM_swapImgRestore()" onMouseOver="PopMenu('PopMenu1',event);MM_swapImage('Image9','','img/menu_on_2.jpg',1)"><img src="img/menu_2.jpg" alt="Business Structure" name="Image9" width="200" height="31" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="products/index.html" onMouseOut="OutMenu('PopMenu3');MM_swapImgRestore()" onMouseOver="PopMenu('PopMenu3',event);MM_swapImage('Image10','','img/menu_on_3.jpg',1)"><img src="img/menu_3.jpg" alt="Products" name="Image10" width="200" height="30" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="news/index.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image11','','img/menu_on_4.jpg',1)"><img src="img/menu_4.jpg" alt="News" name="Image11" width="200" height="31" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="careers/index.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image12','','img/menu_on_5.jpg',1)"><img src="img/menu_5.jpg" alt="Careers" name="Image12" width="200" height="30" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="report/index.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image13','','img/menu_on_6.jpg',1)"><img src="img/menu_6.jpg" alt="Annual Report" name="Image13" width="200" height="31" border="0"></a></td>
        </tr>
        <tr> 
          <td><a href="contact/index.html" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image14','','img/menu_on_7.jpg',1)"><img src="img/menu_7.jpg" alt="Contact Us" name="Image14" width="200" height="29" border="0"></a></td>
        </tr>
      </table></td>
...
<table width="509" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td><a href="../index.asp" onMouseOver="MM_swapImage('Image1','','img/pic_mid2_on-14.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/pic_mid2-14.jpg" alt="Indonesia Version" name="Image1" width="120" height="23" border="0" id="Image1"></a></td>
...
<table width="928" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="108" background="img/bg_line.gif"><img src="img/front_subtitle_02.jpg" width="108" height="13"></td>
    <td width="180" background="img/bg_line.gif"><img src="img/spacer.gif" width="180" height="40"></td>
    <td width="160" background="img/bg_line.gif"><img src="img/front_subtitle_03.jpg" width="160" height="13"></td>
...
<table width="928" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="383" valign="top" background="img/bg_bottom.gif"> <p>&nbsp;&nbsp;&nbsp;&nbsp;PT 
        Sierad Produce Tbk is the entity resulting from the merger in 2001 of 
        four companies conducting the core businesses of the Sierad Group. These 
        were PT Anwar Sierad Tbk, PT Sierad Produce Tbk, and their fully owned 
        subsidiaries, PT Sierad Feedmill and PT Sierad Grains. <br>
        <br>
    ...
    <td width="1" background="img/line.gif"><img src="img/spacer.gif" width="1" height="25"></td>
    <td width="16" background="img/bg_bottom.gif"><img src="img/spacer.gif" width="16" height="25"></td>
    <td width="274" valign="top" background="img/bg_bottom.gif"><strong>November 
        16, 2003, Jakarta.</strong> <br>
        PT Sierad Produce Tbk is the entity resulting from the merger in 2001 
        of four companies conducting the core businesses of the Sierad Group. 
        These were PT Anwar Sierad Tbk, PT Sierad Produce Tbk, and their fully 
        owned subsidiaries, PT Sierad Feedmill and PT Sierad Grains. <br>
        <div align="right">MORE&nbsp;</div>
      <br>
      <strong>November 16, 2003, Jakarta.</strong> <br>
        PT Sierad Produce Tbk is the entity resulting from the merger in 2001 
        of four companies conducting the core businesses of the Sierad Group. 
        These were PT Anwar Sierad Tbk, PT Sierad Produce Tbk, and their fully 
        owned subsidiaries, PT Sierad Feedmill and PT Sierad Grains. <br>
    ...
    <td width="1" background="img/line.gif"><img src="img/spacer.gif" width="1" height="25"></td>
    <td width="16" background="img/bg_bottom.gif"><img src="img/spacer.gif" width="16" height="25"></td>
    <td width="187" valign="top" background="img/bg_bottom.gif">August 14, 2003, 
      7:15 am<br>
      <br>      <table width="95%" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666">
        <tr align="center" bgcolor="CCCCCC"> 
          <td><font color="#5883B6">&nbsp;</font></td>
          <td><font color="#5883B6">Buy</font></td>
          <td><font color="#5883B6">Sell</font></td>
        </tr>
		        <tr align="center"> 
          <td><font color="#003399">USD</font></td>
          <td><font color="#003399">8,533.00</font></td>
          <td><font color="#003399">8,619.00</font></td>
        </tr>
		        <tr align="center"> 
          <td><font color="#003399">EUR</font></td>
          <td><font color="#003399">9,670.45</font></td>
          <td><font color="#003399">9,770.50</font></td>
        </tr>
		        <tr align="center"> 
          <td><font color="#003399">GBP</font></td>
          <td><font color="#003399">13,709.12</font></td>
          <td><font color="#003399">13,854.18</font></td>
        </tr>
		        <tr align="center"> 
          <td><font color="#003399">SGD</font></td>
          <td><font color="#003399">4,843.62</font></td>
          <td><font color="#003399">4,895.21</font></td>
        </tr>
		        <tr align="center"> 
          <td><font color="#003399">JPY</font></td>
          <td><font color="#003399">7,104.32</font></td>
          <td><font color="#003399">7,178.91</font></td>
        </tr>
		        <tr align="center"> 
          <td><font color="#003399">HKD</font></td>
          <td><font color="#003399">1,094.02</font></td>
          <td><font color="#003399">1,105.11</font></td>
        </tr>
		        <tr align="center"> 
          <td><font color="#003399">AUD</font></td>
          <td><font color="#003399">5,512.32</font></td>
          <td><font color="#003399">5,572.18</font></td>
        </tr>
		      </table>
