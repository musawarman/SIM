...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../report/index.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="../business/img/bg_line.gif">::Our Credo:: | ::<a href="shareholder.asp">Report 
      to Shareholders</a>:: | ::<a href="YReview.asp">Year in Review</a>:: | ::<a href="outlook2003.asp">Outlook 
      2003</a>:: | ::<a href="Prospect.asp">Prospect</a>:: |::<a href="future.asp">Our 
      Future</a>:: | ::<a href="commisioners.asp">Commisioners &amp; Directors</a>:: 
      | ::<a href="FinancialReport.pdf">Financial Report</a>:: </td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif"><div align="justify">&nbsp;&nbsp;We 
        are commited to consolidating our position as an integrated food company 
        in order to provide our valued customers with a wide variety of high quality 
        products at the best possible price. </div>
      <p align="justify">We are commited to our creditors and vendors in fulfilling 
        our contractual obligations, and to providing our shareholders with a 
        fair return on their investments.<br>
        <br>
        We are committed to creating a working environment that rewards the creativity 
        and performance of our employers with career advancement and financial 
        gain.</p>
      <p align="justify"> </p>
      <p align="justify">We are commited to good corporate citizenship by observing 
        the laws of the Republic of Indonesia, respecting the environment and 
        bettering the lives of the residents of the communities in which we operate.</p>
      <p> </p></td>
