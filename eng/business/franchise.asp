...
<body background="img/bg.gif" leftmargin="0" topmargin="0" onLoad="MM_preloadImages('img/top_mn_on_06.gif','img/top_mn_on_07.gif','img/bg_mid_on__13.jpg','img/bg_mid_on__14.jpg','img/mn_on_1.jpg','img/mn_on_2.jpg','img/mn_on_3.jpg','img/mn_on_4.jpg','img/mn_on_5.jpg','img/mn_on_6.jpg','img/mn_on_7.jpg','img/mn_on_8.jpg')">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="index.asp"><img src="img/bg_mid__9.jpg" alt="Poultry Division" width="155" height="40" border="0"></a></td>
    ...
    <td><a href="../../business/franchise.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="584" background="img/bg_line.gif">&nbsp;</td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="90" valign="top" background="img/bg_bottom.gif"><div align="center">
        <p><a href="http://www.hartz.co.id"><img src="img/Hartz1.gif" alt="Go to http://www.hartz.co.id" width="69" height="76" border="0"></a></p>
        <p><a href="http://www.wendys.co.id"><img src="img/Logowendys1.gif" alt="Go to http://www.wendys.co.id" width="69" height="76" border="0"></a></p>
      </div></td>
    <td width="561" valign="top" background="img/bg_bottom.gif">&nbsp;&nbsp;&nbsp;&nbsp;Sierad 
      Produce has a two-faceted involvement in the retail food industry, firstly 
      through its exclusive franchise for Wendy's Indonesia, and secondly through 
      its exclusive license for the American-based Hartz &quot;all-you-can-eat&quot; 
      chicken buffet restaurants for Indonesia and selected countries in Asia. 
      The growth of an upwardly mobile urban middle class with a steadily rising 
      income inevitably leads to increased consumption of chicken. In part, this 
      is due to economic, cultural and religious reasons, which combine to make 
      chicken the meat of choice for a significant segment of the Indonesian population. 
      These favorable factors also lead to increased patronage of its franchised 
      restaurants. Sierad Produce's restaurants were selected with these growing 
      market segments in mind.</td>
