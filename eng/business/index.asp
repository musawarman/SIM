...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td><a href="../../business/index.asp" onMouseOver="MM_swapImage('Image1','','img/bg_mid_on__13.jpg',1)" onMouseOut="MM_swapImgRestore()"><img src="img/bg_mid__13.jpg" alt="Indonesia Version" name="Image1" width="175" height="40" border="0" id="Image1"></a></td>
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <td width="561" valign="top" background="img/bg_bottom.gif">&nbsp;&nbsp;&nbsp;&nbsp;Breeding 
      ...
      system. Sierad Produce operates twelve breeding farms and the majority are 
      located in West Java. The farms produce a combined total of more than 120 
      million day-old chicks per annum, catering to Sierad Produce's own businesses 
      as well as for the open market, both domestic and export. 
      <p>I. PRODUCT</p>
      <p>Broiler DOC Layer DOC Male DOC Table Eggs</p>
      <p>II. PRODUCTION PROCESS</p>
      <p>a. Growing Extensive preparations are implemented to secure a clean, 
        hygienic and warm atmosphere for the new parent stock batch. Room temperature 
        and cleanness are monitored regularly, while special drinking and feeding 
        requirements are given. <br>
        b. Eggs Production Female parent stock starts producing fertilized eggs 
        after 24 weeks. During the next 42 weeks, each female parent stock is 
        capable of laying approximately 160 hatching eggs. <br>
        c. Vaccination Health security programs to all of the breeding farms are 
        regularly scheduled and conducted.</p>
      <p>III. FACILITY Laboratory The laboratory is used to facilitate health 
        security programs, conducted at all breeding farms. Unhealthy chickens 
        are examined in the laboratory to determine the appropriate medication.</p>
      <p>IV. LOCATION<br>
        1. Farm 1<br>
