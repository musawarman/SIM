    ...
    <TR> 
      <TD width=1000 valign="top" class=tdtitle> <!-- InstanceBeginEditable name="EditRegion3" --> 
        <TABLE border=0 cellPadding=2 cellSpacing=0 width="100%"><TBODY>
          <TR> 
            <TD class=tdtitle>Add Product (Versi Indonesia)</TD>
          </TR>
          <TR vAlign=top> 
            <TD class=tdverylight> <form action="upload_product.asp" method="post" enctype="multipart/form-data" name="form1">
                <TABLE border=0 cellPadding=2 cellSpacing=1 width="100%">
                  <TBODY>
                    <TR> 
                      <TD align=right class=tddark>Group Id * </TD>
                      <TD class=tddark>:</TD>
                      <TD class=tdlight vAlign=top><select name="SelectGroup" id="SelectGroup">
                          <option value="Biotek">Biotek</option>
                          <option value="Delfarm">Delfarm</option>
                  ...
                  name=p_thumbnail type=file> &nbsp;Max. 65 x 65 px <BR> </TD>
                    </TR>
                    <TR>
                      <TD align=right class=tddark vAlign=top>Picture *&nbsp;</TD>
                      <TD class=tddark vAlign=top>&nbsp;</TD>
                      <TD class=tdlight vAlign=top><input class=btn_file 
                  name=p_picture type=file> &nbsp;Max. 100 x 100 px </TD>
                    </TR>
                    <TR> 
                      <TD align=right class=tddark vAlign=top>Language *</TD>
                      <TD class=tddark vAlign=top>:</TD>
                      <TD class=tdlight vAlign=top><select name="sLang" id="sLang">
