...
rsProfile.Source = "SELECT ID, Del, CompId, Name,Lang, Lead, content, updateby, tgl  FROM dbo.Profile  ORDER BY ID ASC";
              ...
              <TABLE cellSpacing=1 cellPadding=2 width="100%" border=0>
                <FORM action=Add_Profile.asp method=post>
                  <TBODY>
                    ...
                    <TD class=tdbrowsetitle width=200>Company Name</TD>
                    <TD class=tdbrowsetitle width=200>Language</TD>
                  ...
                  width=21 border=0></A> </TD>
                    ...
                    <TD vAlign=top><%=(rsProfile.Fields.Item("lang").Value)%></TD>
