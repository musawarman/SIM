...
rsPesan.Source = "SELECT * FROM dbo.Message ORDER BY IDmsg DESC"
...
Repeat1__numRows = -1
Repeat1__index = 0
rsPesan_numRows = rsPesan_numRows + Repeat1__numRows
%>
<html>
<head>
<title>Buku Tamu :: Sierad</title>
...
<table width="800" border="1" align="center" background="business/img/bg.gif">
  <tr>
    <td><p><img src="Icon/reg.gif" width="29" height="25"><font color="#006600">Buku 
        Tamu</font></p>
      <form name="form1" onSubmit="MM_validateForm('Nama','','R','Email','','NisEmail','Topik','','R','Pesan','','R');return document.MM_returnValue">
        <table width="60%" border="0">
          <% 
While ((Repeat1__numRows <> 0) AND (NOT rsPesan.EOF)) 
%>
          <tr> 
          ...
          <tr> 
            <td width="21%" height="25"> 
              <div align="right">Nama :</div></td>
            <td width="79%"><%=(rsPesan.Fields.Item("Name").Value)%></td>
          </tr>
          <tr> 
            <td><div align="right">Email 
                :</div></td>
            <td><%=(rsPesan.Fields.Item("Email").Value)%></td>
          </tr>
          <tr> 
            <td><div align="right">Topik 
                :</div></td>
            <td><%=(rsPesan.Fields.Item("Topik").Value)%> </td>
          </tr>
          <tr> 
            <td><div align="right">Pesan 
                : </div></td>
            <td><%=(rsPesan.Fields.Item("Message").Value)%></td>
          </tr>
          <tr> 
            <td><div align="right"> 
              </div></td>
          ...
          <tr> 
            <td height="20" colspan="2"> 
              <div align="center"><img src="img/garis1.gif" width="500" height="2"></div></td>
          </tr>
          <% 
