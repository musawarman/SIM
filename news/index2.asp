...
rsNews.Source = "select id,thumbnail,tgl,title,clip, lengkap from dbo.news order by desc"
rsNews.CursorType = 0
...
<table width="988" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="561" valign="top" background="../business/img/bg_bottom.gif">&nbsp;&nbsp;&nbsp;&nbsp;</td>
    ...
    <td width="179" valign="top" background="../business/img/bg_bottom.gif"><strong>16 
      ...
      PT Sierad Feedmill dan PT Sierad Grains.<br>
        <div align="right">MORE&nbsp;</div></td>
