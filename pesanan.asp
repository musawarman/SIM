...
rsProdPesan.Source = "SELECT * FROM dbo.tb_ProdukPesan ORDER BY id_prod DESC"
    ...
    <td height="200"> 
      <div align="center"> 
        <table width="100%" border="2" bordercolor="#009966">
          <tr bordercolor="1"> 
            <td width="54%" height="16"><p>Pesanan Anda:</p>
              <table width="700" border="1" align="center">
                <tr bgcolor="#663366"> 
                  <td> 
                    <div align="center"><font color="#FF3300">Produk ID</font></div></td>
                  <td> 
                    <div align="center"><font color="#FF3300">Nama Produk</font></div></td>
                  <td> 
                    <div align="center"><font color="#FF3300">Kuantitas</font></div></td>
                  <td> 
                ...
                <tr> 
                  ...
                  <td><div align="center"><font color="#006600"><A HREF="pesanan2.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ProdukID=" & rsProdPesan.Fields.Item("ProdukID").Value %>">lihat 
                      harga</A></font></div></td>
                </tr>
              </table>
              <p>&nbsp;</p>
